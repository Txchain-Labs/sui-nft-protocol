...
export function isCritbitTree(type: string): boolean {
  ...
  return type.startsWith(
    "0x5fb957b59e6b093c17eb3f0ca0a3e8762530244f39f738bd356dbdd43ed9230e::critbit_u64::CritbitTree<",
  );
}
...
export class CritbitTree<V extends TypeArgument> implements StructClass {
  ...
  readonly minLeaf: ToField<"u64">;
  readonly maxLeaf: ToField<"u64">;
  ...
  private constructor(typeArgs: [ToTypeStr<V>], fields: CritbitTreeFields<V>) {
    ...
    this.minLeaf = fields.minLeaf;
    this.maxLeaf = fields.maxLeaf;
  ...
  static reified<V extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        CritbitTree.fromFields(V, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        CritbitTree.fromFieldsWithTypes(V, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        CritbitTree.fromSuiParsedData(V, content),
      fetch: async (client: SuiClient, id: string) =>
        CritbitTree.fetch(client, V, id),
  ...
  static fromFields<V extends Reified<TypeArgument, any>>(
    ...
    return CritbitTree.reified(typeArg).new({
      ...
      internalNodes: decodeFromFields(
        Table.reified(
          reified.phantom("u64"),
          reified.phantom(InternalNode.reified()),
        ),
        fields.internal_nodes,
      ),
      leaves: decodeFromFields(
        Table.reified(
          reified.phantom("u64"),
          reified.phantom(Leaf.reified(typeArg)),
        ),
        fields.leaves,
      ),
      minLeaf: decodeFromFields("u64", fields.min_leaf),
      maxLeaf: decodeFromFields("u64", fields.max_leaf),
      nextInternalNodeIndex: decodeFromFields(
        "u64",
        fields.next_internal_node_index,
      ),
  ...
  static fromFieldsWithTypes<V extends Reified<TypeArgument, any>>(
    ...
    return CritbitTree.reified(typeArg).new({
      ...
      minLeaf: decodeFromFieldsWithTypes("u64", item.fields.min_leaf),
      maxLeaf: decodeFromFieldsWithTypes("u64", item.fields.max_leaf),
      nextInternalNodeIndex: decodeFromFieldsWithTypes(
        "u64",
        item.fields.next_internal_node_index,
      ),
      nextLeafIndex: decodeFromFieldsWithTypes(
        "u64",
        item.fields.next_leaf_index,
      ),
    });
  }
  ...
  toJSONField() {
    return {
      ...
      minLeaf: this.minLeaf.toString(),
      maxLeaf: this.maxLeaf.toString(),
  ...
  static fromJSONField<V extends Reified<TypeArgument, any>>(
    ...
    return CritbitTree.reified(typeArg).new({
      ...
      minLeaf: decodeFromJSONField("u64", field.minLeaf),
      maxLeaf: decodeFromJSONField("u64", field.maxLeaf),
      nextInternalNodeIndex: decodeFromJSONField(
        "u64",
        field.nextInternalNodeIndex,
      ),
  ...
  static fromJSON<V extends Reified<TypeArgument, any>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(CritbitTree.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<V extends Reified<TypeArgument, any>>(
    ...
    if (!isCritbitTree(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a CritbitTree object`,
      );
    }
  ...
  static async fetch<V extends Reified<TypeArgument, any>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching CritbitTree object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isCritbitTree(res.data.bcs.type)
    ) {
...
export function isInternalNode(type: string): boolean {
  ...
  return (
    type ===
    "0x5fb957b59e6b093c17eb3f0ca0a3e8762530244f39f738bd356dbdd43ed9230e::critbit_u64::InternalNode"
  );
}
...
export class InternalNode implements StructClass {
  ...
  static reified(): InternalNodeReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        InternalNode.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        InternalNode.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        InternalNode.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        InternalNode.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): InternalNode {
    ...
    if (!isInternalNode(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a InternalNode object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<InternalNode> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching InternalNode object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isInternalNode(res.data.bcs.type)
    ) {
...
export function isLeaf(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0x5fb957b59e6b093c17eb3f0ca0a3e8762530244f39f738bd356dbdd43ed9230e::critbit_u64::Leaf<",
  );
}
...
export class Leaf<V extends TypeArgument> implements StructClass {
  ...
  static reified<V extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Leaf.fromFieldsWithTypes(V, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Leaf.fromSuiParsedData(V, content),
  ...
  static fromJSON<V extends Reified<TypeArgument, any>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(Leaf.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<V extends Reified<TypeArgument, any>>(
    ...
    if (!isLeaf(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Leaf object`,
      );
    }
  ...
  static async fetch<V extends Reified<TypeArgument, any>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Leaf object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isLeaf(res.data.bcs.type)
    ) {
