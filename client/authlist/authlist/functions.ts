...
export function assertVersion(txb: TransactionBlock, authlist: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::authlist::assert_version`,
    arguments: [obj(txb, authlist)],
  });
}
...
export function assertAdminWitness(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, list)],
  });
}

export interface AssertAuthorityArgs {
  authlist: ObjectArg;
  authority: Array<number | TransactionArgument> | TransactionArgument;
}
...
export function assertAuthority(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.authlist),
      pure(txb, args.authority, `vector<u8>`),
    ],
  });
}
...
export function assertCap(txb: TransactionBlock, args: AssertCapArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::authlist::assert_cap`,
    arguments: [obj(txb, args.list), obj(txb, args.cap)],
  });
}
...
export function assertCollection(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.authlist), obj(txb, args.collection)],
  });
}
...
export function borrowAuthorities(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function borrowNames(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function clone(txb: TransactionBlock, authlist: ObjectArg) {
  return txb.moveCall({
...
export interface ContainsAuthorityArgs {
  self: ObjectArg;
  auth: Array<number | TransactionArgument> | TransactionArgument;
}
...
export function containsAuthority(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), pure(txb, args.auth, `vector<u8>`)],
  });
}
...
export function containsCollection(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), obj(txb, args.collection)],
  });
}
...
export function containsName(txb: TransactionBlock, args: ContainsNameArgs) {
  return txb.moveCall({
...
export function deleteAuthlist(txb: TransactionBlock, authlist: ObjectArg) {
  return txb.moveCall({
...
export function deleteOwnerCap(txb: TransactionBlock, ownerCap: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::authlist::delete_owner_cap`,
    arguments: [obj(txb, ownerCap)],
  });
}

export function initAuthlist(txb: TransactionBlock) {
  return txb.moveCall({
...
export function initCloned(txb: TransactionBlock, authlist: ObjectArg) {
  return txb.moveCall({
...
export function insertAuthority_(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), pure(txb, args.authority, `vector<u8>`)],
  });
}
...
export function insertCollection(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), obj(txb, args.collectionPub)],
  });
}
...
export function migrate(txb: TransactionBlock, args: MigrateArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::authlist::migrate`,
    arguments: [obj(txb, args.authlist), obj(txb, args.cap)],
  });
}
...
export function setName(txb: TransactionBlock, args: SetNameArgs) {
  return txb.moveCall({
...
export function setName_(txb: TransactionBlock, args: SetName_Args) {
  return txb.moveCall({
