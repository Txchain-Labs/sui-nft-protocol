...
export function new_(txb: TransactionBlock, max: bigint | TransactionArgument) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::utils_supply::new`,
    arguments: [pure(txb, max, `u64`)],
  });
}
...
export function split(txb: TransactionBlock, args: SplitArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::utils_supply::split`,
    arguments: [obj(txb, args.supply), pure(txb, args.value, `u64`)],
  });
}
...
export function assertZero(txb: TransactionBlock, supply: ObjectArg) {
  return txb.moveCall({
...
export function decrement(txb: TransactionBlock, args: DecrementArgs) {
  return txb.moveCall({
...
export function getCurrent(txb: TransactionBlock, supply: ObjectArg) {
  return txb.moveCall({
...
export function getMax(txb: TransactionBlock, supply: ObjectArg) {
  return txb.moveCall({
...
export function getRemaining(txb: TransactionBlock, supply: ObjectArg) {
  return txb.moveCall({
...
export function merge(txb: TransactionBlock, args: MergeArgs) {
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.supply), obj(txb, args.other)],
  });
}
