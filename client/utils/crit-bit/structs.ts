...
export function isCritbitTree(type: string): boolean {
  ...
  return type.startsWith(
    "0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<",
  );
}
...
export function isInternalNode(type: string): boolean {
  ...
  return (
    type ===
    "0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::InternalNode"
  );
}
...
export function isLeaf(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::Leaf<",
  );
}
