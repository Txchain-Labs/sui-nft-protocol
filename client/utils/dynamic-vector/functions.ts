...
export function pushBack(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), generic(txb, `${typeArg}`, args.elem)],
  });
}
...
export function delete_(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export function borrowAtIndex(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), pure(txb, args.index, `u64`)],
  });
}

export interface BorrowChunkArgs {
  v: ObjectArg;
  chunkIdx: bigint | TransactionArgument;
}
...
export function borrowChunk(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), pure(txb, args.chunkIdx, `u64`)],
  });
}
...
export function chunkIndex(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), pure(txb, args.idx, `u64`)],
  });
}
...
export function insertChunk(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), generic(txb, `${typeArg}`, args.element)],
  });
}
