...
export function append(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.lhs), obj(txb, args.other)],
  });
}
...
export function borrow(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), pure(txb, args.i, `u64`)],
  });
}
...
export function contains(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), generic(txb, `${typeArg}`, args.e)],
  });
}
...
export function empty(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [pure(txb, capacity, `u64`)],
  });
}
...
export function isEmpty(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export function length(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export function popBack(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export function reverse(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export function capacity(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
...
export interface DecreaseCapacityArgs {
  v: ObjectArg;
  bump: bigint | TransactionArgument;
}
...
export function decreaseCapacity(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.v), pure(txb, args.bump, `u64`)],
  });
}
...
export function slack(txb: TransactionBlock, typeArg: string, v: ObjectArg) {
  return txb.moveCall({
