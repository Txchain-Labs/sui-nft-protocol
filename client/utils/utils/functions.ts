...
export function bps(txb: TransactionBlock) {
  return txb.moveCall({
...
export function getPackageModuleType(txb: TransactionBlock, typeArg: string) {
  return txb.moveCall({
...
export function getPackageModuleTypeRaw(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, t, `0x1::string::String`)],
  });
}
...
export function insertVecInTable(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.table), vector(txb, `${typeArg}`, args.vec)],
  });
}
...
export function insertVecInVecSet(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.set), vector(txb, `${typeArg}`, args.vec)],
  });
}

export function isShared(txb: TransactionBlock) {
  return txb.moveCall({
...
export function marker(txb: TransactionBlock, typeArg: string) {
  return txb.moveCall({
...
export function originbyteDocsUrl(txb: TransactionBlock) {
  return txb.moveCall({
...
export function sumVector(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, vec, `vector<u64>`)],
  });
}
...
export function tableVecFromVec(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [vector(txb, `${typeArg}`, vec)],
  });
}
