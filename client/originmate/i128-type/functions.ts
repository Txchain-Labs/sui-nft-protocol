...
export function isZero(txb: TransactionBlock, x: ObjectArg) {
  return txb.moveCall({
...
export function abs(txb: TransactionBlock, x: ObjectArg) {
  return txb.moveCall({
...
export function asU128(txb: TransactionBlock, x: ObjectArg) {
  return txb.moveCall({
...
export function compare(txb: TransactionBlock, args: CompareArgs) {
  return txb.moveCall({
...
export function from(txb: TransactionBlock, x: bigint | TransactionArgument) {
  return txb.moveCall({
...
export function isNeg(txb: TransactionBlock, x: ObjectArg) {
  return txb.moveCall({
...
export function neg(txb: TransactionBlock, x: ObjectArg) {
  return txb.moveCall({
