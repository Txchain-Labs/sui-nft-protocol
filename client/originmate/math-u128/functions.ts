...
export function sqrt(txb: TransactionBlock, a: bigint | TransactionArgument) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::math_u128::sqrt`,
    arguments: [pure(txb, a, `u128`)],
  });
}
...
export function average(txb: TransactionBlock, args: AverageArgs) {
  return txb.moveCall({
...
export function ceilDiv(txb: TransactionBlock, args: CeilDivArgs) {
  return txb.moveCall({
...
export function exp(txb: TransactionBlock, args: ExpArgs) {
  return txb.moveCall({
...
export function quadratic(txb: TransactionBlock, args: QuadraticArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::math_u128::quadratic`,
    arguments: [
      pure(txb, args.x, `u128`),
      pure(txb, args.a, `u128`),
      pure(txb, args.b, `u128`),
      pure(txb, args.c, `u128`),
    ],
  });
}
...
export interface SqrtRoundingArgs {
  a: bigint | TransactionArgument;
  rounding: number | TransactionArgument;
}

export function sqrtRounding(txb: TransactionBlock, args: SqrtRoundingArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::math_u128::sqrt_rounding`,
    arguments: [pure(txb, args.a, `u128`), pure(txb, args.rounding, `u8`)],
  });
}
