...
export function isTypedID(type: string): boolean {
  ...
  return type.startsWith(
    "0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::typed_id::TypedID<",
  );
}
...
export class TypedID<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        TypedID.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TypedID.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => TypedID.fromBcs(T, data),
      bcs: TypedID.bcs,
      fromJSONField: (field: any) => TypedID.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => TypedID.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TypedID.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        TypedID.fetch(client, T, id),
      new: (fields: TypedIDFields<ToPhantomTypeArgument<T>>) => {
        return new TypedID([extractType(T)], fields);
      },
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(TypedID.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TypedID.reified(typeArg).new({
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TypedID.fromFields(typeArg, TypedID.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(TypedID.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isTypedID(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TypedID object`,
      );
    }
    return TypedID.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching TypedID object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTypedID(res.data.bcs.type)
    ) {
