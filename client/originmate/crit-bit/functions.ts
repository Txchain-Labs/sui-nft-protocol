...
export function borrow(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.cb), pure(txb, args.k, `u128`)],
  });
}
...
export function insert(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.cb),
      pure(txb, args.k, `u128`),
      generic(txb, `${typeArg}`, args.v),
    ],
  });
}

export function isEmpty(txb: TransactionBlock, typeArg: string, cb: ObjectArg) {
  return txb.moveCall({
...
export function length(txb: TransactionBlock, typeArg: string, cb: ObjectArg) {
  return txb.moveCall({
...
export function singleton(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [pure(txb, args.k, `u128`), generic(txb, `${typeArg}`, args.v)],
  });
}
...
export function pop(txb: TransactionBlock, typeArg: string, args: PopArgs) {
  return txb.moveCall({
...
export function bSO(txb: TransactionBlock, typeArg: string, args: BSOArgs) {
  return txb.moveCall({
...
export function bSOM(txb: TransactionBlock, typeArg: string, args: BSOMArgs) {
  return txb.moveCall({
...
export function checkLen(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, l, `u64`)],
  });
}

export interface CritBitArgs {
  s1: bigint | TransactionArgument;
  s2: bigint | TransactionArgument;
}

export function critBit(txb: TransactionBlock, args: CritBitArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::crit_bit::crit_bit`,
    arguments: [pure(txb, args.s1, `u128`), pure(txb, args.s2, `u128`)],
  });
}
...
export interface InsertAboveArgs {
  ...
  k: bigint | TransactionArgument;
  v: GenericArg;
  nO: bigint | TransactionArgument;
  iNI: bigint | TransactionArgument;
  iSP: bigint | TransactionArgument;
...
export function insertAbove(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.k, `u128`),
      generic(txb, `${typeArg}`, args.v),
      pure(txb, args.nO, `u64`),
      pure(txb, args.iNI, `u64`),
      pure(txb, args.iSP, `u64`),
      pure(txb, args.c, `u8`),
    ],
  });
}
...
export interface InsertBelowArgs {
  ...
  nO: bigint | TransactionArgument;
  iNI: bigint | TransactionArgument;
  iSO: bigint | TransactionArgument;
  sSO: boolean | TransactionArgument;
  kSO: bigint | TransactionArgument;
  iSP: bigint | TransactionArgument;
  c: number | TransactionArgument;
}
...
export function insertBelow(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.nO, `u64`),
      pure(txb, args.iNI, `u64`),
      pure(txb, args.iSO, `u64`),
      pure(txb, args.sSO, `bool`),
      pure(txb, args.kSO, `u128`),
      pure(txb, args.iSP, `u64`),
      pure(txb, args.c, `u8`),
    ],
  });
...
export interface InsertBelowWalkArgs {
  ...
  nO: bigint | TransactionArgument;
  iNI: bigint | TransactionArgument;
  iNR: bigint | TransactionArgument;
  c: number | TransactionArgument;
}
...
export function isOut(txb: TransactionBlock, i: bigint | TransactionArgument) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::crit_bit::is_out`,
    arguments: [pure(txb, i, `u64`)],
  });
}
...
export function isSet(txb: TransactionBlock, args: IsSetArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::crit_bit::is_set`,
    arguments: [pure(txb, args.k, `u128`), pure(txb, args.b, `u8`)],
  });
}

export function maxKey(txb: TransactionBlock, typeArg: string, cb: ObjectArg) {
  return txb.moveCall({
...
export function minKey(txb: TransactionBlock, typeArg: string, cb: ObjectArg) {
  return txb.moveCall({
...
export function oC(txb: TransactionBlock, v: bigint | TransactionArgument) {
  return txb.moveCall({
...
export function oV(txb: TransactionBlock, c: bigint | TransactionArgument) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::crit_bit::o_v`,
    arguments: [pure(txb, c, `u64`)],
  });
}

export interface PopDestroyNodesArgs {
  cb: ObjectArg;
  iI: bigint | TransactionArgument;
  iO: bigint | TransactionArgument;
  nO: bigint | TransactionArgument;
}
...
export function popDestroyNodes(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.cb),
      pure(txb, args.iI, `u64`),
      pure(txb, args.iO, `u64`),
      pure(txb, args.nO, `u64`),
    ],
  });
}
...
export interface PopUpdateRelationshipsArgs {
  cb: ObjectArg;
  sC: boolean | TransactionArgument;
  iP: bigint | TransactionArgument;
}
...
export function popUpdateRelationships(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.cb),
      pure(txb, args.sC, `bool`),
      pure(txb, args.iP, `u64`),
    ],
  });
}
...
export interface PushBackInsertNodesArgs {
  ...
  c: number | TransactionArgument;
  iP: bigint | TransactionArgument;
  iNCC: boolean | TransactionArgument;
  c1: bigint | TransactionArgument;
  c2: bigint | TransactionArgument;
}
...
export function pushBackInsertNodes(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.c, `u8`),
      pure(txb, args.iP, `u64`),
      pure(txb, args.iNCC, `bool`),
      pure(txb, args.c1, `u64`),
      pure(txb, args.c2, `u64`),
    ],
  });
}
...
export interface TraverseCIArgs {
  cb: ObjectArg;
  k: bigint | TransactionArgument;
  pF: bigint | TransactionArgument;
  d: boolean | TransactionArgument;
}
...
export function traverseCI(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.cb),
      pure(txb, args.k, `u128`),
      pure(txb, args.pF, `u64`),
      pure(txb, args.d, `bool`),
    ],
  });
}
...
export function traverseInitMut(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.cb), pure(txb, args.d, `bool`)],
  });
}
