...
export function addDays(txb: TransactionBlock, args: AddDaysArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_days`,
    arguments: [pure(txb, args.timestamp, `u64`), pure(txb, args.days, `u64`)],
  });
}

export interface AddHoursArgs {
  timestamp: bigint | TransactionArgument;
  hours: bigint | TransactionArgument;
}

export function addHours(txb: TransactionBlock, args: AddHoursArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_hours`,
    arguments: [pure(txb, args.timestamp, `u64`), pure(txb, args.hours, `u64`)],
  });
}

export interface AddMinutesArgs {
  timestamp: bigint | TransactionArgument;
  minutes: bigint | TransactionArgument;
}

export function addMinutes(txb: TransactionBlock, args: AddMinutesArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_minutes`,
    arguments: [
      pure(txb, args.timestamp, `u64`),
      pure(txb, args.minutes, `u64`),
    ],
  });
}
...
export interface AddMonthsArgs {
  timestamp: bigint | TransactionArgument;
  months: bigint | TransactionArgument;
}

export function addMonths(txb: TransactionBlock, args: AddMonthsArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_months`,
    arguments: [
      pure(txb, args.timestamp, `u64`),
      pure(txb, args.months, `u64`),
    ],
  });
}
...
export interface AddSecondsArgs {
  timestamp: bigint | TransactionArgument;
  seconds: bigint | TransactionArgument;
}

export function addSeconds(txb: TransactionBlock, args: AddSecondsArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_seconds`,
    arguments: [
      pure(txb, args.timestamp, `u64`),
      pure(txb, args.seconds, `u64`),
    ],
  });
}
...
export interface AddYearsArgs {
  timestamp: bigint | TransactionArgument;
  years: bigint | TransactionArgument;
}

export function addYears(txb: TransactionBlock, args: AddYearsArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::add_years`,
    arguments: [pure(txb, args.timestamp, `u64`), pure(txb, args.years, `u64`)],
  });
}

export interface DaysFromDateArgs {
  year: bigint | TransactionArgument;
  month: bigint | TransactionArgument;
  day: bigint | TransactionArgument;
}

export function daysFromDate(txb: TransactionBlock, args: DaysFromDateArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::days_from_date`,
    arguments: [
      pure(txb, args.year, `u64`),
      pure(txb, args.month, `u64`),
      pure(txb, args.day, `u64`),
    ],
  });
}
...
export function daysToDate(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, days, `u64`)],
  });
}

export interface DiffDaysArgs {
  fromTimestamp: bigint | TransactionArgument;
  toTimestamp: bigint | TransactionArgument;
}

export function diffDays(txb: TransactionBlock, args: DiffDaysArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::date::diff_days`,
    arguments: [
      pure(txb, args.fromTimestamp, `u64`),
      pure(txb, args.toTimestamp, `u64`),
    ],
  });
}
...
export function diffHours(txb: TransactionBlock, args: DiffHoursArgs) {
  return txb.moveCall({
...
export function diffMinutes(txb: TransactionBlock, args: DiffMinutesArgs) {
  return txb.moveCall({
...
export function diffMonths(txb: TransactionBlock, args: DiffMonthsArgs) {
  return txb.moveCall({
...
export function diffSeconds(txb: TransactionBlock, args: DiffSecondsArgs) {
  return txb.moveCall({
...
export function diffYears(txb: TransactionBlock, args: DiffYearsArgs) {
  return txb.moveCall({
...
export function getDay(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, timestamp, `u64`)],
  });
}
...
export function getDaysInYearMonth(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, args.year, `u64`), pure(txb, args.month, `u64`)],
  });
}
...
export function isValidDate(txb: TransactionBlock, args: IsValidDateArgs) {
  return txb.moveCall({
...
export interface IsValidDateTimeArgs {
  ...
  month: bigint | TransactionArgument;
  day: bigint | TransactionArgument;
  hour: bigint | TransactionArgument;
  minute: bigint | TransactionArgument;
  second: bigint | TransactionArgument;
}
...
export function isValidDateTime(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.month, `u64`),
      pure(txb, args.day, `u64`),
      pure(txb, args.hour, `u64`),
      pure(txb, args.minute, `u64`),
      pure(txb, args.second, `u64`),
    ],
  });
}
...
export function subDays(txb: TransactionBlock, args: SubDaysArgs) {
  return txb.moveCall({
...
export function subHours(txb: TransactionBlock, args: SubHoursArgs) {
  return txb.moveCall({
...
export function subMinutes(txb: TransactionBlock, args: SubMinutesArgs) {
  return txb.moveCall({
...
export function subMonths(txb: TransactionBlock, args: SubMonthsArgs) {
  return txb.moveCall({
...
export function subSeconds(txb: TransactionBlock, args: SubSecondsArgs) {
  return txb.moveCall({
...
export function subYears(txb: TransactionBlock, args: SubYearsArgs) {
  return txb.moveCall({
