...
export function destroyEmpty(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function joinWith(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), obj(txb, args.with)],
  });
}
...
export function withdrawAllFrom(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), obj(txb, args.from)],
  });
}
