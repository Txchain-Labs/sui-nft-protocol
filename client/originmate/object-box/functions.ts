...
export function borrow(txb: TransactionBlock, typeArg: string, ob: ObjectArg) {
  return txb.moveCall({
...
export function isEmpty(txb: TransactionBlock, ob: ObjectArg) {
  return txb.moveCall({
...
export function remove(txb: TransactionBlock, typeArg: string, ob: ObjectArg) {
  return txb.moveCall({
...
export function add(txb: TransactionBlock, typeArg: string, args: AddArgs) {
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.ob), generic(txb, `${typeArg}`, args.v)],
  });
}
...
export function new_(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [generic(txb, `${typeArg}`, object)],
  });
}
