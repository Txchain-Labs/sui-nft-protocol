...
export function assertVersion(txb: TransactionBlock, allowlist: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::allowlist::assert_version`,
    arguments: [obj(txb, allowlist)],
  });
}
...
export function assertAuthority(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.allowlist), obj(txb, args.auth)],
  });
}
...
export function assertCollection(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.allowlist), obj(txb, args.collection)],
  });
}
...
export function clone(txb: TransactionBlock, allowlist: ObjectArg) {
  return txb.moveCall({
...
export function containsAuthority(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), obj(txb, args.auth)],
  });
}
...
export function initCloned(txb: TransactionBlock, allowlist: ObjectArg) {
  return txb.moveCall({
...
export function insertAuthority(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.cap), obj(txb, args.self)],
  });
}
...
export function migrate(txb: TransactionBlock, args: MigrateArgs) {
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.allowlist), obj(txb, args.cap)],
  });
}
...
export function deleteAllowlist(txb: TransactionBlock, allowlist: ObjectArg) {
  return txb.moveCall({
...
export function initAllowlist(txb: TransactionBlock) {
  return txb.moveCall({
