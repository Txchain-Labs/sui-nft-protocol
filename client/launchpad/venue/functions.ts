...
export function delete_(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [generic(txb, `${typeArgs[1]}`, args.key), obj(txb, args.venue)],
  });
}

export function assertIsLive(txb: TransactionBlock, venue: ObjectArg) {
  return txb.moveCall({
...
export function assertIsWhitelisted(txb: TransactionBlock, venue: ObjectArg) {
  return txb.moveCall({
...
export function isWhitelisted(txb: TransactionBlock, venue: ObjectArg) {
  return txb.moveCall({
...
export function isLive(txb: TransactionBlock, venue: ObjectArg) {
  return txb.moveCall({
...
export interface SetLiveArgs {
  venue: ObjectArg;
  isLive: boolean | TransactionArgument;
}

export function setLive(txb: TransactionBlock, args: SetLiveArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::venue::set_live`,
    arguments: [obj(txb, args.venue), pure(txb, args.isLive, `bool`)],
  });
}
...
export function setWhitelisted(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.venue), pure(txb, args.isWhitelisted, `bool`)],
  });
}
