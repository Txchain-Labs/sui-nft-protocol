...
export interface NewArgs {
  listingAdmin: string | TransactionArgument;
...
export function new_(txb: TransactionBlock, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      pure(txb, args.listingAdmin, `address`),
...
export interface SupplyArgs {
  listing: ObjectArg;
  inventoryId: string | TransactionArgument;
}
...
export function supply(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      pure(txb, args.inventoryId, `0x2::object::ID`),
    ],
  });
}
...
export function pay(txb: TransactionBlock, typeArg: string, args: PayArgs) {
  return txb.moveCall({
...
export function receiver(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::listing::receiver`,
    arguments: [obj(txb, listing)],
  });
}
...
export function addMember(txb: TransactionBlock, args: AddMemberArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::listing::add_member`,
    arguments: [obj(txb, args.listing), pure(txb, args.member, `address`)],
  });
}

export function assertVersion(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function removeMember(txb: TransactionBlock, args: RemoveMemberArgs) {
  return txb.moveCall({
...
export function admin(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function migrate(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export interface BuyNftArgs {
  ...
  key: GenericArg;
  inventoryId: string | TransactionArgument;
  venueId: string | TransactionArgument;
  buyer: string | TransactionArgument;
  funds: ObjectArg;
}
...
export function buyNft(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      generic(txb, `${typeArgs[3]}`, args.key),
      pure(txb, args.inventoryId, `0x2::object::ID`),
      pure(txb, args.venueId, `0x2::object::ID`),
      pure(txb, args.buyer, `address`),
      obj(txb, args.funds),
    ],
  });
}
...
export interface InitVenueArgs {
  ...
  key: GenericArg;
  market: GenericArg;
  isWhitelisted: boolean | TransactionArgument;
}
...
export function initVenue(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      generic(txb, `${typeArgs[1]}`, args.key),
      generic(txb, `${typeArgs[0]}`, args.market),
      pure(txb, args.isWhitelisted, `bool`),
    ],
  });
}
...
export function applyRebate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.listing), obj(txb, args.wallet)],
  });
}
...
export interface FundRebateArgs {
  listing: ObjectArg;
  wallet: ObjectArg;
  fundAmount: bigint | TransactionArgument;
}
...
export function sendRebate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.listing), pure(txb, args.receiver, `address`)],
  });
}

export interface SetRebateArgs {
  listing: ObjectArg;
  rebateAmount: bigint | TransactionArgument;
}
...
export function setRebate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.listing), pure(txb, args.rebateAmount, `u64`)],
  });
}
...
export function isAdminOrMember(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function acceptListingRequest(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.marketplace), obj(txb, args.listing)],
  });
}
...
export function addFee(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [
      obj(txb, args.marketplace),
      obj(txb, args.listing),
      generic(txb, `${typeArg}`, args.fee),
    ],
  });
}
...
export function addInventory(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.listing), obj(txb, args.inventory)],
  });
}
...
export function addVenue(txb: TransactionBlock, args: AddVenueArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::listing::add_venue`,
    arguments: [obj(txb, args.listing), obj(txb, args.venue)],
  });
}
...
export function addWarehouse(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.listing), obj(txb, args.warehouse)],
  });
}
...
export function addWhitelistInternal(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      pure(txb, args.venueId, `0x2::object::ID`),
      generic(txb, `${typeArg}`, args.whitelist),
    ],
  });
}
...
export function assertDefaultFee(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function assertListingAdmin(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function assertVenue(txb: TransactionBlock, args: AssertVenueArgs) {
  return txb.moveCall({
...
export function borrowMembers(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function borrowProceeds(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function borrowProceedsMut(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function borrowVenue(txb: TransactionBlock, args: BorrowVenueArgs) {
  return txb.moveCall({
...
export interface BuyRandomNftArgs {
  ...
  userCommitment: Array<number | TransactionArgument> | TransactionArgument;
  inventoryId: string | TransactionArgument;
  venueId: string | TransactionArgument;
  buyer: string | TransactionArgument;
  funds: ObjectArg;
...
export function buyRandomNft(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      generic(txb, `${typeArgs[3]}`, args.key),
      obj(txb, args.commitment),
      pure(txb, args.userCommitment, `vector<u8>`),
      pure(txb, args.inventoryId, `0x2::object::ID`),
      pure(txb, args.venueId, `0x2::object::ID`),
      pure(txb, args.buyer, `address`),
      obj(txb, args.funds),
...
export function containsCustomFee(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function containsVenue(txb: TransactionBlock, args: ContainsVenueArgs) {
  return txb.moveCall({
...
export function customFee(txb: TransactionBlock, listing: ObjectArg) {
  return txb.moveCall({
...
export function emitSoldEvent(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [
      generic(txb, `${typeArgs[1]}`, args.nft),
...
export function initListing(txb: TransactionBlock, args: InitListingArgs) {
  return txb.moveCall({
...
export function inventoryInternalMut(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.listing),
      generic(txb, `${typeArgs[2]}`, args.key),
      pure(txb, args.venueId, `0x2::object::ID`),
      pure(txb, args.inventoryId, `0x2::object::ID`),
    ],
  });
...
export function saleOff(txb: TransactionBlock, args: SaleOffArgs) {
  return txb.moveCall({
...
export function saleOn(txb: TransactionBlock, args: SaleOnArgs) {
  return txb.moveCall({
...
export function sendRebateFundsToSender(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.listing), pure(txb, args.amount, `u64`)],
  });
}

export interface SetStartSaleTimeArgs {
  listing: ObjectArg;
  startTimeTs: bigint | TransactionArgument;
  venueId: string | TransactionArgument;
}
