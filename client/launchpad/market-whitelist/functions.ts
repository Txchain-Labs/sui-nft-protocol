...
export function burn(txb: TransactionBlock, certificate: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::market_whitelist::burn`,
    arguments: [obj(txb, certificate)],
  });
}
...
export interface AddAddressesArgs {
  listing: ObjectArg;
  venueId: string | TransactionArgument;
  wlAddresses: Array<string | TransactionArgument> | TransactionArgument;
}

export function addAddresses(txb: TransactionBlock, args: AddAddressesArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::market_whitelist::add_addresses`,
    arguments: [
      obj(txb, args.listing),
      pure(txb, args.venueId, `0x2::object::ID`),
      pure(txb, args.wlAddresses, `vector<address>`),
    ],
  });
}
...
export function addWhitelist(txb: TransactionBlock, args: AddWhitelistArgs) {
  return txb.moveCall({
...
export function assertWhitelist(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.certificate), obj(txb, args.venue)],
  });
}

export interface AssertWlAddressArgs {
  whitelist: ObjectArg;
  wlAddress: string | TransactionArgument;
}
...
export function assertWlAddress(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.whitelist), pure(txb, args.wlAddress, `address`)],
  });
}
...
export function issue(txb: TransactionBlock, args: IssueArgs) {
  return txb.moveCall({
