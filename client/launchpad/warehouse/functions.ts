...
export function depositNft(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.warehouse), generic(txb, `${typeArg}`, args.nft)],
  });
}
...
export function initRedeemCommitment(
  txb: TransactionBlock,
  hashedSenderCommitment:
    | Array<number | TransactionArgument>
    | TransactionArgument,
) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::warehouse::init_redeem_commitment`,
    arguments: [pure(txb, hashedSenderCommitment, `vector<u8>`)],
  });
}

export function initWarehouse(txb: TransactionBlock, typeArg: string) {
  return txb.moveCall({
...
export function redeemNftAtIndex(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.warehouse), pure(txb, args.index, `u64`)],
  });
}
...
export function select(txb: TransactionBlock, args: SelectArgs) {
  return txb.moveCall({
