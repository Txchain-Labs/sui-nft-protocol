...
export function isMarketKey(type: string): boolean {
  ...
  return (
    type ===
    "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::limited_fixed_price::MarketKey"
  );
}
...
export function isLimitedFixedPriceMarket(type: string): boolean {
  ...
  return type.startsWith(
    "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::limited_fixed_price::LimitedFixedPriceMarket<",
  );
}
...
export interface LimitedFixedPriceMarketFields<FT extends PhantomTypeArgument> {
  ...
  addresses: ToField<VecMap<"address", "u64">>;
}

export type LimitedFixedPriceMarketReified<FT extends PhantomTypeArgument> =
  Reified<LimitedFixedPriceMarket<FT>, LimitedFixedPriceMarketFields<FT>>;
  ...
  implements StructClass
{
  ...
  readonly addresses: ToField<VecMap<"address", "u64">>;

  private constructor(
    typeArgs: [PhantomToTypeStr<FT>],
    fields: LimitedFixedPriceMarketFields<FT>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        LimitedFixedPriceMarket.fromFields(FT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        LimitedFixedPriceMarket.fromFieldsWithTypes(FT, item),
      fromBcs: (data: Uint8Array) => LimitedFixedPriceMarket.fromBcs(FT, data),
      bcs: LimitedFixedPriceMarket.bcs,
      fromJSONField: (field: any) =>
        LimitedFixedPriceMarket.fromJSONField(FT, field),
      fromJSON: (json: Record<string, any>) =>
        LimitedFixedPriceMarket.fromJSON(FT, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        LimitedFixedPriceMarket.fromSuiParsedData(FT, content),
      fetch: async (client: SuiClient, id: string) =>
        LimitedFixedPriceMarket.fetch(client, FT, id),
      new: (
        fields: LimitedFixedPriceMarketFields<ToPhantomTypeArgument<FT>>,
      ) => {
        return new LimitedFixedPriceMarket([extractType(FT)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    ToTypeStr<LimitedFixedPriceMarket<ToPhantomTypeArgument<FT>>>
  > {
    return phantom(LimitedFixedPriceMarket.reified(FT));
  }
  ...
  static fromFields<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return LimitedFixedPriceMarket.reified(typeArg).new({
  ...
  static fromFieldsWithTypes<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return LimitedFixedPriceMarket.reified(typeArg).new({
      ...
      addresses: decodeFromFieldsWithTypes(
        VecMap.reified("address", "u64"),
        item.fields.addresses,
      ),
    });
  }
  ...
  toJSONField() {
    return {
      ...
      addresses: this.addresses.toJSONField(),
    };
  }
  ...
  static fromJSON<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(LimitedFixedPriceMarket.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isLimitedFixedPriceMarket(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a LimitedFixedPriceMarket object`,
      );
    }
    return LimitedFixedPriceMarket.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching LimitedFixedPriceMarket object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isLimitedFixedPriceMarket(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a LimitedFixedPriceMarket object`,
      );
    }
