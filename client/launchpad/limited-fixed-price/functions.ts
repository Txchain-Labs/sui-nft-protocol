...
export function assertLimit(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.market), pure(txb, args.limit, `u64`)],
  });
}
...
export function borrowCount(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.market), pure(txb, args.who, `address`)],
  });
}
