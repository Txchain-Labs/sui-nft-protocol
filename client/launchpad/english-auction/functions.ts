...
export function new_(
  ...
  return txb.moveCall({
    ...
    arguments: [generic(txb, `${typeArgs[0]}`, args.nft), obj(txb, args.bid)],
  });
}
...
export interface CreateBidArgs {
  ...
  bid: bigint | TransactionArgument;
}
...
export function createBid_(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.auction), obj(txb, args.bid)],
  });
}
...
export function bidFromCoin(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.wallet), pure(txb, args.bid, `u64`)],
  });
}
