...
export interface AddArgs {
  proceeds: ObjectArg;
  newProceeds: ObjectArg;
  qtySold: bigint | TransactionArgument;
}
...
export function add(txb: TransactionBlock, typeArg: string, args: AddArgs) {
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.proceeds),
      obj(txb, args.newProceeds),
      pure(txb, args.qtySold, `u64`),
    ],
  });
}
...
export interface CollectWithFeesArgs {
  proceeds: ObjectArg;
  fees: bigint | TransactionArgument;
  marketplaceReceiver: string | TransactionArgument;
  listingReceiver: string | TransactionArgument;
}
...
export function collectWithFees(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.proceeds),
      pure(txb, args.fees, `u64`),
      pure(txb, args.marketplaceReceiver, `address`),
      pure(txb, args.listingReceiver, `address`),
    ],
  });
}
...
export function collected(txb: TransactionBlock, proceeds: ObjectArg) {
  return txb.moveCall({
...
export function total(txb: TransactionBlock, proceeds: ObjectArg) {
  return txb.moveCall({
