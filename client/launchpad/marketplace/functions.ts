...
export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      ...
      generic(txb, `${typeArg}`, args.defaultFee),
    ],
  });
}

export function receiver(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::marketplace::receiver`,
    arguments: [obj(txb, marketplace)],
  });
}
...
export function addMember(txb: TransactionBlock, args: AddMemberArgs) {
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.marketplace), pure(txb, args.member, `address`)],
  });
}

export function assertVersion(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
...
export function admin(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
...
export function migrate(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
...
export function defaultFee(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
...
export function isAdminOrMember(txb: TransactionBlock, marketplace: ObjectArg) {
  return txb.moveCall({
