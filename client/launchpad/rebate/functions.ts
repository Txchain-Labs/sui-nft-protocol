...
export function applyRebate(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.object), obj(txb, args.wallet)],
  });
}
...
export function sendRebate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.object), pure(txb, args.receiver, `address`)],
  });
}
...
export function setRebate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.object), pure(txb, args.rebateAmount, `u64`)],
  });
}
