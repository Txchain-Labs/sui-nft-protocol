...
export function isBid(type: string): boolean {
  ...
  return type.startsWith(
    "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::dutch_auction::Bid<",
  );
}

export interface BidFields<FT extends PhantomTypeArgument> {
  amount: ToField<Balance<FT>>;
...
export class Bid<FT extends PhantomTypeArgument> implements StructClass {
  ...
  readonly amount: ToField<Balance<FT>>;
  ...
  static fromFields<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Bid.reified(typeArg).new({
      amount: decodeFromFields(Balance.reified(typeArg), fields.amount),
  ...
  static fromFieldsWithTypes<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Bid.reified(typeArg).new({
      amount: decodeFromFieldsWithTypes(
  ...
  static fromJSONField<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Bid.reified(typeArg).new({
      amount: decodeFromJSONField(Balance.reified(typeArg), field.amount),
...
export function isMarketKey(type: string): boolean {
  ...
  return (
    type ===
    "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::dutch_auction::MarketKey"
  );
}
...
export function isDutchAuctionMarket(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::dutch_auction::DutchAuctionMarket<",
  );
}

export interface DutchAuctionMarketFields<FT extends PhantomTypeArgument> {
  id: ToField<UID>;
  reservePrice: ToField<"u64">;
  bids: ToField<CritbitTree<Vector<Bid<FT>>>>;
  inventoryId: ToField<ID>;
}
  ...
  implements StructClass
{
  ...
  readonly reservePrice: ToField<"u64">;
  readonly bids: ToField<CritbitTree<Vector<Bid<FT>>>>;
  readonly inventoryId: ToField<ID>;

  private constructor(
    typeArgs: [PhantomToTypeStr<FT>],
    fields: DutchAuctionMarketFields<FT>,
  ) {
    this.$fullTypeName = composeSuiType(
    ...
    this.id = fields.id;
    this.reservePrice = fields.reservePrice;
    this.bids = fields.bids;
    this.inventoryId = fields.inventoryId;
  }
  ...
  static reified<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        DutchAuctionMarket.fromFields(FT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DutchAuctionMarket.fromFieldsWithTypes(FT, item),
      fromBcs: (data: Uint8Array) => DutchAuctionMarket.fromBcs(FT, data),
      bcs: DutchAuctionMarket.bcs,
      fromJSONField: (field: any) =>
        DutchAuctionMarket.fromJSONField(FT, field),
      fromJSON: (json: Record<string, any>) =>
        DutchAuctionMarket.fromJSON(FT, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        DutchAuctionMarket.fromSuiParsedData(FT, content),
      fetch: async (client: SuiClient, id: string) =>
        DutchAuctionMarket.fetch(client, FT, id),
      new: (fields: DutchAuctionMarketFields<ToPhantomTypeArgument<FT>>) => {
        return new DutchAuctionMarket([extractType(FT)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(DutchAuctionMarket.reified(FT));
  }
  ...
  static get bcs() {
    return bcs.struct("DutchAuctionMarket", {
      ...
      bids: CritbitTree.bcs(bcs.vector(Bid.bcs)),
      inventory_id: ID.bcs,
    });
  }
  ...
  static fromFields<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return DutchAuctionMarket.reified(typeArg).new({
      id: decodeFromFields(UID.reified(), fields.id),
      reservePrice: decodeFromFields("u64", fields.reserve_price),
      bids: decodeFromFields(
        CritbitTree.reified(reified.vector(Bid.reified(typeArg))),
        fields.bids,
      ),
      inventoryId: decodeFromFields(ID.reified(), fields.inventory_id),
    });
  }
  ...
  static fromFieldsWithTypes<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return DutchAuctionMarket.reified(typeArg).new({
      ...
      reservePrice: decodeFromFieldsWithTypes("u64", item.fields.reserve_price),
      bids: decodeFromFieldsWithTypes(
        CritbitTree.reified(reified.vector(Bid.reified(typeArg))),
        item.fields.bids,
      ),
      inventoryId: decodeFromFieldsWithTypes(
        ID.reified(),
        item.fields.inventory_id,
      ),
    });
  }
  ...
  toJSONField() {
    return {
      id: this.id,
      reservePrice: this.reservePrice.toString(),
  ...
  static fromJSONField<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return DutchAuctionMarket.reified(typeArg).new({
      ...
      reservePrice: decodeFromJSONField("u64", field.reservePrice),
      bids: decodeFromJSONField(
        CritbitTree.reified(reified.vector(Bid.reified(typeArg))),
        field.bids,
      ),
      inventoryId: decodeFromJSONField(ID.reified(), field.inventoryId),
    });
  }
  ...
  static fromJSON<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(DutchAuctionMarket.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isDutchAuctionMarket(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a DutchAuctionMarket object`,
      );
    }
    return DutchAuctionMarket.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<FT extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching DutchAuctionMarket object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isDutchAuctionMarket(res.data.bcs.type)
    ) {
