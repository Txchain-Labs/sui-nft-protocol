...
export interface NewArgs {
  ...
  reservePrice: bigint | TransactionArgument;
}
...
export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.reservePrice, `u64`),
    ],
  });
}
...
export function cancelBid_(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [
      obj(txb, args.auction),
      obj(txb, args.wallet),
      pure(txb, args.price, `u64`),
      pure(txb, args.sender, `address`),
    ],
  });
}
...
export interface ConcludeAuctionArgs {
  auction: ObjectArg;
  nftsToSell: bigint | TransactionArgument;
}
...
export function concludeAuction(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.auction), pure(txb, args.nftsToSell, `u64`)],
  });
}
