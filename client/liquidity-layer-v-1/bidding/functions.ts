...
export interface CreateBidArgs {
  buyersKiosk: string | TransactionArgument;
  nft: string | TransactionArgument;
...
export function createBid(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [
      pure(txb, args.buyersKiosk, `0x2::object::ID`),
      pure(txb, args.nft, `0x2::object::ID`),
...
export function newBid(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      option(
        txb,
        `0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::BidCommission<${typeArg}>`,
        args.commission,
      ),
      obj(txb, args.wallet),
    ],
...
export function sellNft(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.bid),
      obj(txb, args.buyersKiosk),
      generic(txb, `${typeArgs[0]}`, args.nft),
    ],
  });
}
...
export function share(txb: TransactionBlock, typeArg: string, bid: ObjectArg) {
  return txb.moveCall({
