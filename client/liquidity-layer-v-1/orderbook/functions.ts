...
export function new__(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, protectedActions)],
  });
}

export interface CreateBidArgs {
  book: ObjectArg;
  buyerKiosk: ObjectArg;
...
export interface CreateBidWithCommissionArgs {
  ...
  buyerKiosk: ObjectArg;
  price: bigint | TransactionArgument;
  beneficiary: string | TransactionArgument;
  commissionFt: bigint | TransactionArgument;
  wallet: ObjectArg;
}
...
export function createBidWithCommission(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      obj(txb, args.buyerKiosk),
      pure(txb, args.price, `u64`),
      pure(txb, args.beneficiary, `address`),
      pure(txb, args.commissionFt, `u64`),
      obj(txb, args.wallet),
    ],
  });
}
...
export interface AddAdministratorArgs {
  publisher: ObjectArg;
  orderbook: ObjectArg;
  administrator: string | TransactionArgument;
}
...
export function addAdministrator(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      obj(txb, args.orderbook),
      pure(txb, args.administrator, `address`),
    ],
  });
}
...
export function askCommission(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::orderbook::ask_commission`,
    arguments: [obj(txb, ask)],
  });
}

export function askKioskId(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
...
export function askNftId(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
...
export function askOwner(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
...
export function askPrice(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
...
export interface AssertTickLevelArgs {
  price: bigint | TransactionArgument;
  tickSize: bigint | TransactionArgument;
}
...
export function assertTickLevel(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, args.price, `u64`), pure(txb, args.tickSize, `u64`)],
  });
}
...
export function borrowAdministratorsMutOrCreate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.witness), obj(txb, args.orderbook)],
  });
}
...
export interface CancelAskArgs {
  book: ObjectArg;
  sellerKiosk: ObjectArg;
  nftPriceLevel: bigint | TransactionArgument;
  nftId: string | TransactionArgument;
}
...
export function cancelAsk(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      obj(txb, args.sellerKiosk),
      pure(txb, args.nftPriceLevel, `u64`),
      pure(txb, args.nftId, `0x2::object::ID`),
    ],
  });
}
...
export interface CancelBidArgs {
  book: ObjectArg;
  bidPriceLevel: bigint | TransactionArgument;
  wallet: ObjectArg;
}
...
export function cancelBid(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      pure(txb, args.bidPriceLevel, `u64`),
      obj(txb, args.wallet),
    ],
  });
}
...
export interface ChangeTickSizeArgs {
  witness: ObjectArg;
  book: ObjectArg;
  newTick: bigint | TransactionArgument;
}
...
export interface CreateAskArgs {
  book: ObjectArg;
  sellerKiosk: ObjectArg;
  requestedTokens: bigint | TransactionArgument;
  nftId: string | TransactionArgument;
}
...
export function createAsk(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      obj(txb, args.sellerKiosk),
      pure(txb, args.requestedTokens, `u64`),
      pure(txb, args.nftId, `0x2::object::ID`),
    ],
  });
}
...
export interface CreateAsk_Args {
  ...
  sellerKiosk: ObjectArg;
  price: bigint | TransactionArgument;
  askCommission: ObjectArg | TransactionArgument | null;
  nftId: string | TransactionArgument;
}
...
export function createAsk_(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      option(
        txb,
        `0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::AskCommission`,
        args.askCommission,
      ),
      pure(txb, args.nftId, `0x2::object::ID`),
    ],
...
export interface CreateBid_Args {
  ...
  buyerKiosk: ObjectArg;
  price: bigint | TransactionArgument;
  bidCommission: ObjectArg | TransactionArgument | null;
  wallet: ObjectArg;
}
...
export function createBid_(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      option(
        txb,
        `0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::BidCommission<${typeArgs[1]}>`,
        args.bidCommission,
      ),
      obj(txb, args.wallet),
    ],
...
export function createUnprotected(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.witness), obj(txb, args.transferPolicy)],
  });
}

export interface CustomProtectionArgs {
  buyNft: boolean | TransactionArgument;
  createAsk: boolean | TransactionArgument;
  createBid: boolean | TransactionArgument;
}
...
export function customProtection(
  ...
  return txb.moveCall({
    ...
    arguments: [
      pure(txb, args.buyNft, `bool`),
      pure(txb, args.createAsk, `bool`),
      pure(txb, args.createBid, `bool`),
    ],
  });
}
...
export function disableOrderbook(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.publisher), obj(txb, args.orderbook)],
  });
}
...
export interface EditAskArgs {
  book: ObjectArg;
  sellerKiosk: ObjectArg;
  oldPrice: bigint | TransactionArgument;
  nftId: string | TransactionArgument;
  newPrice: bigint | TransactionArgument;
}
...
export function editAsk(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      obj(txb, args.sellerKiosk),
      pure(txb, args.oldPrice, `u64`),
      pure(txb, args.nftId, `0x2::object::ID`),
      pure(txb, args.newPrice, `u64`),
    ],
  });
}
...
export function enableTradingPermissionless(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.orderbook), obj(txb, args.clock)],
  });
}

export interface FinishTradeArgs {
  book: ObjectArg;
  tradeId: string | TransactionArgument;
  sellerKiosk: ObjectArg;
  buyerKiosk: ObjectArg;
}
...
export function finishTrade(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      pure(txb, args.tradeId, `0x2::object::ID`),
      obj(txb, args.sellerKiosk),
      obj(txb, args.buyerKiosk),
    ],
  });
...
export function tradeId(txb: TransactionBlock, trade: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::orderbook::trade_id`,
    arguments: [obj(txb, trade)],
  });
}
...
export interface MarketBuyArgs {
  ...
  buyerKiosk: ObjectArg;
  wallet: ObjectArg;
  maxPrice: bigint | TransactionArgument;
}
...
export interface MatchBuyWithAsk_Args {
  book: ObjectArg;
  lowestAskPrice: bigint | TransactionArgument;
  buyerKioskId: string | TransactionArgument;
  bidCommission: ObjectArg | TransactionArgument | null;
  wallet: ObjectArg;
}
...
export function matchBuyWithAsk_(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      pure(txb, args.lowestAskPrice, `u64`),
      pure(txb, args.buyerKioskId, `0x2::object::ID`),
      option(
        txb,
        `0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::BidCommission<${typeArgs[1]}>`,
        args.bidCommission,
...
export interface MatchSellWithBid_Args {
  book: ObjectArg;
  highestBidPrice: bigint | TransactionArgument;
  sellerKioskId: string | TransactionArgument;
  askCommission: ObjectArg | TransactionArgument | null;
  nftId: string | TransactionArgument;
}
...
export function matchSellWithBid_(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.book),
      pure(txb, args.highestBidPrice, `u64`),
      pure(txb, args.sellerKioskId, `0x2::object::ID`),
      option(
        txb,
        `0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::AskCommission`,
        args.askCommission,
...
export function noProtection(txb: TransactionBlock) {
  return txb.moveCall({
...
export function removeAsk(txb: TransactionBlock, args: RemoveAskArgs) {
  return txb.moveCall({
...
export function setProtection_(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.orderbook), obj(txb, args.protectedActions)],
  });
}
...
export function setStartTime_(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.orderbook), pure(txb, args.startTime, `u64`)],
  });
}
...
export function tradePrice(txb: TransactionBlock, trade: ObjectArg) {
  return txb.moveCall({
