...
export function askCommissionAmount(txb: TransactionBlock, ask: ObjectArg) {
  return txb.moveCall({
...
export function extractAskCommission(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.commission), obj(txb, args.source)],
  });
}

export interface NewAskCommissionArgs {
  beneficiary: string | TransactionArgument;
  cut: bigint | TransactionArgument;
}
...
export function newBidCommission(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [pure(txb, args.beneficiary, `address`), obj(txb, args.cut)],
  });
}
