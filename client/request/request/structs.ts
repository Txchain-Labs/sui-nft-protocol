...
export function isPolicy(type: string): boolean {
  ...
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::Policy<",
  );
}
...
export class Policy<P extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [P],
      fromFields: (fields: Record<string, any>) => Policy.fromFields(P, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Policy.fromFieldsWithTypes(P, item),
      fromBcs: (data: Uint8Array) => Policy.fromBcs(P, data),
      bcs: Policy.bcs,
      fromJSONField: (field: any) => Policy.fromJSONField(P, field),
      fromJSON: (json: Record<string, any>) => Policy.fromJSON(P, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Policy.fromSuiParsedData(P, content),
      fetch: async (client: SuiClient, id: string) =>
        Policy.fetch(client, P, id),
      new: (fields: PolicyFields<ToPhantomTypeArgument<P>>) => {
        return new Policy([extractType(P)], fields);
      },
  ...
  static phantom<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(Policy.reified(P));
  }
  ...
  static fromFields<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Policy.reified(typeArg).new({
  ...
  static fromBcs<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Policy.fromFields(typeArg, Policy.bcs.parse(data));
  }
  ...
  static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(Policy.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isPolicy(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Policy object`,
      );
    }
    return Policy.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Policy object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isPolicy(res.data.bcs.type)
    ) {
...
export function isPolicyCap(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::PolicyCap"
  );
}
...
export class PolicyCap implements StructClass {
  ...
  static reified(): PolicyCapReified {
    return {
      ...
      typeArgs: [] as [],
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) => PolicyCap.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PolicyCap.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => PolicyCap.fromBcs(data),
      bcs: PolicyCap.bcs,
      fromJSONField: (field: any) => PolicyCap.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => PolicyCap.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        PolicyCap.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        PolicyCap.fetch(client, id),
      new: (fields: PolicyCapFields) => {
        return new PolicyCap([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): PolicyCap {
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): PolicyCap {
  ...
  static fromBcs(data: Uint8Array): PolicyCap {
    return PolicyCap.fromFields(PolicyCap.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): PolicyCap {
    return PolicyCap.reified().new({
      id: decodeFromJSONField(UID.reified(), field.id),
  ...
  static fromJSON(json: Record<string, any>): PolicyCap {
  ...
  static fromSuiParsedData(content: SuiParsedData): PolicyCap {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isPolicyCap(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a PolicyCap object`,
      );
    }
    return PolicyCap.fromFieldsWithTypes(content);
  }

  static async fetch(client: SuiClient, id: string): Promise<PolicyCap> {
    const res = await client.getObject({
      id,
      options: {
        showBcs: true,
    ...
    if (res.error) {
      throw new Error(
        `error fetching PolicyCap object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isPolicyCap(res.data.bcs.type)
    ) {
...
export function isRequestBody(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::RequestBody<",
  );
}
...
export class RequestBody<P extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        RequestBody.fromFields(P, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RequestBody.fromFieldsWithTypes(P, item),
      fromBcs: (data: Uint8Array) => RequestBody.fromBcs(P, data),
      bcs: RequestBody.bcs,
      fromJSONField: (field: any) => RequestBody.fromJSONField(P, field),
      fromJSON: (json: Record<string, any>) => RequestBody.fromJSON(P, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RequestBody.fromSuiParsedData(P, content),
      fetch: async (client: SuiClient, id: string) =>
        RequestBody.fetch(client, P, id),
      new: (fields: RequestBodyFields<ToPhantomTypeArgument<P>>) => {
        return new RequestBody([extractType(P)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(RequestBody.reified(P));
  }
  ...
  static fromFields<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return RequestBody.reified(typeArg).new({
  ...
  static fromBcs<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    return RequestBody.fromFields(typeArg, RequestBody.bcs.parse(data));
  }
  ...
  static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(RequestBody.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isRequestBody(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a RequestBody object`,
      );
    }
    return RequestBody.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching RequestBody object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRequestBody(res.data.bcs.type)
    ) {
...
export function isRuleStateDfKey(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::RuleStateDfKey<",
  );
}
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<Rule>],
    fields: RuleStateDfKeyFields<Rule>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      typeArgs: [extractType(Rule)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<Rule>>,
      ],
      reifiedTypeArgs: [Rule],
      fromFields: (fields: Record<string, any>) =>
        RuleStateDfKey.fromFields(Rule, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RuleStateDfKey.fromFieldsWithTypes(Rule, item),
      fromBcs: (data: Uint8Array) => RuleStateDfKey.fromBcs(Rule, data),
      bcs: RuleStateDfKey.bcs,
      fromJSONField: (field: any) => RuleStateDfKey.fromJSONField(Rule, field),
      fromJSON: (json: Record<string, any>) =>
        RuleStateDfKey.fromJSON(Rule, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        RuleStateDfKey.fromSuiParsedData(Rule, content),
      fetch: async (client: SuiClient, id: string) =>
        RuleStateDfKey.fetch(client, Rule, id),
      new: (fields: RuleStateDfKeyFields<ToPhantomTypeArgument<Rule>>) => {
        return new RuleStateDfKey([extractType(Rule)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(RuleStateDfKey.reified(Rule));
  }
  ...
  static fromFields<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    return RuleStateDfKey.reified(typeArg).new({
  ...
  static fromBcs<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    return RuleStateDfKey.fromFields(typeArg, RuleStateDfKey.bcs.parse(data));
  }
  ...
  static fromJSON<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(RuleStateDfKey.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isRuleStateDfKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a RuleStateDfKey object`,
      );
    }
    return RuleStateDfKey.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<Rule extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching RuleStateDfKey object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRuleStateDfKey(res.data.bcs.type)
    ) {
...
export function isWithNft(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::WithNft<",
  );
}

export interface WithNftFields<
...
export type WithNftReified<
  T extends PhantomTypeArgument,
  P extends PhantomTypeArgument,
> = Reified<WithNft<T, P>, WithNftFields<T, P>>;

export class WithNft<
  T extends PhantomTypeArgument,
  P extends PhantomTypeArgument,
> implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>, PhantomToTypeStr<P>],
    fields: WithNftFields<T, P>,
  ) {
    this.$fullTypeName = composeSuiType(
      WithNft.$typeName,
      ...typeArgs,
  ...
  >(
    ...
    return {
      ...
      typeArgs: [extractType(T), extractType(P)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T>>,
        PhantomToTypeStr<ToPhantomTypeArgument<P>>,
      ],
      reifiedTypeArgs: [T, P],
      fromFields: (fields: Record<string, any>) =>
        WithNft.fromFields([T, P], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        WithNft.fromFieldsWithTypes([T, P], item),
      fromBcs: (data: Uint8Array) => WithNft.fromBcs([T, P], data),
      bcs: WithNft.bcs,
      fromJSONField: (field: any) => WithNft.fromJSONField([T, P], field),
      fromJSON: (json: Record<string, any>) => WithNft.fromJSON([T, P], json),
      fromSuiParsedData: (content: SuiParsedData) =>
        WithNft.fromSuiParsedData([T, P], content),
      fetch: async (client: SuiClient, id: string) =>
        WithNft.fetch(client, [T, P], id),
      new: (
        fields: WithNftFields<
          ToPhantomTypeArgument<T>,
          ToPhantomTypeArgument<P>
        >,
      ) => {
        return new WithNft([extractType(T), extractType(P)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  >(
    ...
    ToTypeStr<WithNft<ToPhantomTypeArgument<T>, ToPhantomTypeArgument<P>>>
  > {
    return phantom(WithNft.reified(T, P));
  }
  ...
  >(
    ...
    return WithNft.reified(typeArgs[0], typeArgs[1]).new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }
  ...
  >(
    ...
    return WithNft.fromFields(typeArgs, WithNft.bcs.parse(data));
  }
  ...
  >(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(WithNft.$typeName, ...typeArgs.map(extractType)),
      json.$typeArgs,
      typeArgs,
    );
  ...
  >(
    ...
    if (!isWithNft(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a WithNft object`,
      );
    }
    return WithNft.fromFieldsWithTypes(typeArgs, content);
  }
  ...
  >(
    ...
    if (res.error) {
      throw new Error(
        `error fetching WithNft object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isWithNft(res.data.bcs.type)
    ) {
