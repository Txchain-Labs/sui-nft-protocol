...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::withdraw_request::Witness"
  );
}
...
export function isWITHDRAW_REQ(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::withdraw_request::WITHDRAW_REQ"
  );
}
...
export class WITHDRAW_REQ implements StructClass {
  ...
  static reified(): WITHDRAW_REQReified {
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        WITHDRAW_REQ.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        WITHDRAW_REQ.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => WITHDRAW_REQ.fromBcs(data),
      bcs: WITHDRAW_REQ.bcs,
      fromJSONField: (field: any) => WITHDRAW_REQ.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => WITHDRAW_REQ.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        WITHDRAW_REQ.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        WITHDRAW_REQ.fetch(client, id),
      new: (fields: WITHDRAW_REQFields) => {
        return new WITHDRAW_REQ([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): WITHDRAW_REQ {
    return WITHDRAW_REQ.reified().new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): WITHDRAW_REQ {
  ...
  static fromBcs(data: Uint8Array): WITHDRAW_REQ {
    return WITHDRAW_REQ.fromFields(WITHDRAW_REQ.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): WITHDRAW_REQ {
    return WITHDRAW_REQ.reified().new({
      dummyField: decodeFromJSONField("bool", field.dummyField),
    });
  }

  static fromJSON(json: Record<string, any>): WITHDRAW_REQ {
  ...
  static fromSuiParsedData(content: SuiParsedData): WITHDRAW_REQ {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isWITHDRAW_REQ(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a WITHDRAW_REQ object`,
      );
    }
    return WITHDRAW_REQ.fromFieldsWithTypes(content);
  }

  static async fetch(client: SuiClient, id: string): Promise<WITHDRAW_REQ> {
    const res = await client.getObject({
      id,
      options: {
        showBcs: true,
    ...
    if (res.error) {
      throw new Error(
        `error fetching WITHDRAW_REQ object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isWITHDRAW_REQ(res.data.bcs.type)
    ) {
...
export function isWithdrawRequest(type: string): boolean {
  ...
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::withdraw_request::WithdrawRequest<",
  );
}

export interface WithdrawRequestFields<T extends PhantomTypeArgument> {
  sender: ToField<"address">;
  inner: ToField<RequestBody<ToPhantom<WithNft<T, ToPhantom<WITHDRAW_REQ>>>>>;
}
  ...
  implements StructClass
{
  ...
  readonly inner: ToField<
    RequestBody<ToPhantom<WithNft<T, ToPhantom<WITHDRAW_REQ>>>>
  >;

  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: WithdrawRequestFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        WithdrawRequest.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        WithdrawRequest.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => WithdrawRequest.fromBcs(T, data),
      bcs: WithdrawRequest.bcs,
      fromJSONField: (field: any) => WithdrawRequest.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        WithdrawRequest.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        WithdrawRequest.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        WithdrawRequest.fetch(client, T, id),
      new: (fields: WithdrawRequestFields<ToPhantomTypeArgument<T>>) => {
        return new WithdrawRequest([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(WithdrawRequest.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return WithdrawRequest.reified(typeArg).new({
      sender: decodeFromFields("address", fields.sender),
      inner: decodeFromFields(
        RequestBody.reified(
          reified.phantom(
            WithNft.reified(typeArg, reified.phantom(WITHDRAW_REQ.reified())),
          ),
        ),
        fields.inner,
      ),
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return WithdrawRequest.fromFields(typeArg, WithdrawRequest.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(WithdrawRequest.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isWithdrawRequest(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a WithdrawRequest object`,
      );
    }
    return WithdrawRequest.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching WithdrawRequest object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isWithdrawRequest(res.data.bcs.type)
    ) {
