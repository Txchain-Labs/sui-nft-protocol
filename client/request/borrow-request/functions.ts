...
export function addReceipt(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.self), generic(txb, `${typeArgs[2]}`, args.rule)],
  });
}
...
export function borrowField(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.witness), obj(txb, args.nftUid)],
  });
}
...
export function borrowNft(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.witness), obj(txb, args.request)],
  });
}
