...
export interface NewArgs {
  ...
  kioskId: string | TransactionArgument;
...
export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.kioskId, `0x2::object::ID`),
...
export function addReceipt(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), generic(txb, `${typeArgs[1]}`, args.rule)],
  });
}

export function inner(txb: TransactionBlock, typeArg: string, self: ObjectArg) {
  return txb.moveCall({
...
export function confirm(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.self), obj(txb, args.policy)],
  });
}
...
export function nft(txb: TransactionBlock, typeArg: string, self: ObjectArg) {
  return txb.moveCall({
