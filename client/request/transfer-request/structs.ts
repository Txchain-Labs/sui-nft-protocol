...
export function isTransferRequest(type: string): boolean {
  ...
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<",
  );
}

export interface TransferRequestFields<T extends PhantomTypeArgument> {
  nft: ToField<ID>;
  originator: ToField<"address">;
  beneficiary: ToField<"address">;
  inner: ToField<TransferRequest1<T>>;
  metadata: ToField<UID>;
}
  ...
  implements StructClass
{
  ...
  readonly originator: ToField<"address">;
  readonly beneficiary: ToField<"address">;
  readonly inner: ToField<TransferRequest1<T>>;
  readonly metadata: ToField<UID>;
  ...
  private constructor(
    ...
    this.nft = fields.nft;
    this.originator = fields.originator;
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TransferRequest.reified(typeArg).new({
      ...
      originator: decodeFromFields("address", fields.originator),
      beneficiary: decodeFromFields("address", fields.beneficiary),
      inner: decodeFromFields(TransferRequest1.reified(typeArg), fields.inner),
      metadata: decodeFromFields(UID.reified(), fields.metadata),
    });
  }
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TransferRequest.reified(typeArg).new({
      ...
      originator: decodeFromFieldsWithTypes("address", item.fields.originator),
      beneficiary: decodeFromFieldsWithTypes(
        "address",
        item.fields.beneficiary,
      ),
      inner: decodeFromFieldsWithTypes(
        TransferRequest1.reified(typeArg),
        item.fields.inner,
      ),
      metadata: decodeFromFieldsWithTypes(UID.reified(), item.fields.metadata),
    });
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TransferRequest.reified(typeArg).new({
      ...
      originator: decodeFromJSONField("address", field.originator),
      beneficiary: decodeFromJSONField("address", field.beneficiary),
      inner: decodeFromJSONField(
        TransferRequest1.reified(typeArg),
        field.inner,
      ),
      metadata: decodeFromJSONField(UID.reified(), field.metadata),
    });
  }
...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::Witness"
  );
}
...
export function isBalanceAccessCap(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::BalanceAccessCap<",
  );
}
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: BalanceAccessCapFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        BalanceAccessCap.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BalanceAccessCap.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => BalanceAccessCap.fromBcs(T, data),
      bcs: BalanceAccessCap.bcs,
      fromJSONField: (field: any) => BalanceAccessCap.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        BalanceAccessCap.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BalanceAccessCap.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        BalanceAccessCap.fetch(client, T, id),
      new: (fields: BalanceAccessCapFields<ToPhantomTypeArgument<T>>) => {
        return new BalanceAccessCap([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(BalanceAccessCap.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BalanceAccessCap.reified(typeArg).new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(BalanceAccessCap.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isBalanceAccessCap(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a BalanceAccessCap object`,
      );
    }
    return BalanceAccessCap.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching BalanceAccessCap object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBalanceAccessCap(res.data.bcs.type)
    ) {
...
export function isBalanceDfKey(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::BalanceDfKey"
  );
}
...
export class BalanceDfKey implements StructClass {
  ...
  static reified(): BalanceDfKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        BalanceDfKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BalanceDfKey.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => BalanceDfKey.fromBcs(data),
      bcs: BalanceDfKey.bcs,
      fromJSONField: (field: any) => BalanceDfKey.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => BalanceDfKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BalanceDfKey.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        BalanceDfKey.fetch(client, id),
      new: (fields: BalanceDfKeyFields) => {
        return new BalanceDfKey([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): BalanceDfKey {
    return BalanceDfKey.reified().new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): BalanceDfKey {
  ...
  static fromBcs(data: Uint8Array): BalanceDfKey {
    return BalanceDfKey.fromFields(BalanceDfKey.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): BalanceDfKey {
    return BalanceDfKey.reified().new({
      dummyField: decodeFromJSONField("bool", field.dummyField),
    });
  }

  static fromJSON(json: Record<string, any>): BalanceDfKey {
  ...
  static fromSuiParsedData(content: SuiParsedData): BalanceDfKey {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isBalanceDfKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a BalanceDfKey object`,
      );
    }
    return BalanceDfKey.fromFieldsWithTypes(content);
  }

  static async fetch(client: SuiClient, id: string): Promise<BalanceDfKey> {
    const res = await client.getObject({
      id,
      options: {
        showBcs: true,
    ...
    if (res.error) {
      throw new Error(
        `error fetching BalanceDfKey object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBalanceDfKey(res.data.bcs.type)
    ) {
...
export function isOBCustomRulesDfKey(type: string): boolean {
  ...
  return (
    type ===
    "0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::OBCustomRulesDfKey"
  );
}
...
export class OBCustomRulesDfKey implements StructClass {
  ...
  static reified(): OBCustomRulesDfKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        OBCustomRulesDfKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        OBCustomRulesDfKey.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => OBCustomRulesDfKey.fromBcs(data),
      bcs: OBCustomRulesDfKey.bcs,
      fromJSONField: (field: any) => OBCustomRulesDfKey.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        OBCustomRulesDfKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        OBCustomRulesDfKey.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        OBCustomRulesDfKey.fetch(client, id),
      new: (fields: OBCustomRulesDfKeyFields) => {
  ...
  static fromFields(fields: Record<string, any>): OBCustomRulesDfKey {
    return OBCustomRulesDfKey.reified().new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): OBCustomRulesDfKey {
  ...
  static fromBcs(data: Uint8Array): OBCustomRulesDfKey {
    return OBCustomRulesDfKey.fromFields(OBCustomRulesDfKey.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): OBCustomRulesDfKey {
    return OBCustomRulesDfKey.reified().new({
      dummyField: decodeFromJSONField("bool", field.dummyField),
    });
  }

  static fromJSON(json: Record<string, any>): OBCustomRulesDfKey {
  ...
  static fromSuiParsedData(content: SuiParsedData): OBCustomRulesDfKey {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isOBCustomRulesDfKey(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a OBCustomRulesDfKey object`,
      );
    }
    return OBCustomRulesDfKey.fromFieldsWithTypes(content);
  }
  ...
  static async fetch(
    ...
    if (res.error) {
      throw new Error(
        `error fetching OBCustomRulesDfKey object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isOBCustomRulesDfKey(res.data.bcs.type)
    ) {
