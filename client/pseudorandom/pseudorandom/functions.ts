...
export function increment(txb: TransactionBlock, counter: ObjectArg) {
  return txb.moveCall({
...
export function nonceCounter(txb: TransactionBlock, counter: ObjectArg) {
  return txb.moveCall({
...
export function noncePrimitives(txb: TransactionBlock) {
  return txb.moveCall({
...
export function rand(txb: TransactionBlock, args: RandArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::pseudorandom::rand`,
    arguments: [pure(txb, args.nonce, `vector<u8>`), obj(txb, args.counter)],
  });
}
...
export function randNoCounter(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, nonce, `vector<u8>`)],
  });
}
...
export function randNoCtx(txb: TransactionBlock, args: RandNoCtxArgs) {
  return txb.moveCall({
...
export function randNoNonce(txb: TransactionBlock, counter: ObjectArg) {
  return txb.moveCall({
...
export function randWithCounter(txb: TransactionBlock, counter: ObjectArg) {
  return txb.moveCall({
...
export function randWithCtx(txb: TransactionBlock) {
  return txb.moveCall({
...
export interface SelectU64Args {
  bound: bigint | TransactionArgument;
  random: Array<number | TransactionArgument> | TransactionArgument;
}

export function selectU64(txb: TransactionBlock, args: SelectU64Args) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::pseudorandom::select_u64`,
    arguments: [
      pure(txb, args.bound, `u64`),
      pure(txb, args.random, `vector<u8>`),
    ],
  });
}
