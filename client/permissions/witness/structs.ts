...
export function isWitness(type: string): boolean {
  ...
  return type.startsWith(
    "0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<",
  );
}
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        Witness.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Witness.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Witness.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        Witness.fetch(client, T, id),
...
export function isWitnessGenerator(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::WitnessGenerator<",
  );
}
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: WitnessGeneratorFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        WitnessGenerator.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        WitnessGenerator.fromFieldsWithTypes(T, item),
      ...
      fromJSON: (json: Record<string, any>) =>
        WitnessGenerator.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        WitnessGenerator.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isWitnessGenerator(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a WitnessGenerator object`,
      );
    }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching WitnessGenerator object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isWitnessGenerator(res.data.bcs.type)
    ) {
