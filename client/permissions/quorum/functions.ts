...
export function create(
  ...
  return txb.moveCall({
    ...
    arguments: [
      generic(txb, `${typeArg}`, args.witness),
      obj(txb, args.admins),
      obj(txb, args.members),
      obj(txb, args.delegates),
    ],
  });
}
...
export interface AddAdminWithExtensionArgs {
  quorum: ObjectArg;
  extToken: ObjectArg;
  newAdmin: string | TransactionArgument;
}
...
export function addAdminWithExtension(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      obj(txb, args.extToken),
      pure(txb, args.newAdmin, `address`),
    ],
  });
}
...
export function addDelegateWithExtension(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      obj(txb, args.extToken),
      pure(txb, args.entity, `0x2::object::ID`),
    ],
  });
}
...
export function addMember(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.quorum), pure(txb, args.member, `address`)],
  });
}
...
export function assertAdmin(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, quorum)],
  });
}

export interface AssertDelegateArgs {
  quorum: ObjectArg;
  delegateUid: ObjectArg;
}
...
export function assertDelegate(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.quorum), obj(txb, args.delegateUid)],
  });
}
...
export function assertExtensionToken(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.quorum), obj(txb, args.extToken)],
  });
}
...
export function borrowCapAsDelegate(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.quorum), obj(txb, args.delegate)],
  });
}
...
export function calcVotingThreshold(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, adminCount, `u64`)],
  });
}
...
export interface InsertCapArgs {
  quorum: ObjectArg;
  capObject: GenericArg;
  adminOnly: boolean | TransactionArgument;
}
...
export function insertCap(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      generic(txb, `${typeArgs[1]}`, args.capObject),
      pure(txb, args.adminOnly, `bool`),
    ],
  });
}
...
export interface RemoveAdminWithExtensionArgs {
  quorum: ObjectArg;
  extToken: ObjectArg;
  oldAdmin: string | TransactionArgument;
}
...
export function removeAdminWithExtension(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      obj(txb, args.extToken),
      pure(txb, args.oldAdmin, `address`),
    ],
  });
}
...
export function returnCapAsDelegate(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      obj(txb, args.delegate),
      generic(txb, `${typeArgs[2]}`, args.capObject),
      obj(txb, args.receipt),
    ],
  });
}

export function sign(txb: TransactionBlock, typeArg: string, sigs: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::quorum::sign`,
    typeArguments: [typeArg],
    arguments: [obj(txb, sigs)],
  });
}
...
export function vote(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.quorum),
      generic(txb, `${typeArgs[1]}`, args.field),
    ],
  });
}
...
export function voteAddAdmin(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.quorum), pure(txb, args.newAdmin, `address`)],
  });
}
...
export function voteRemoveAdmin(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.quorum), pure(txb, args.oldAdmin, `address`)],
  });
}
