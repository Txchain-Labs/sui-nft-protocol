...
export interface NewArgs {
  mintCap: ObjectArg;
  supply: bigint | TransactionArgument;
}
...
export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.mintCap), pure(txb, args.supply, `u64`)],
  });
}
...
export function split(txb: TransactionBlock, typeArg: string, args: SplitArgs) {
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.mintPass), pure(txb, args.supply, `u64`)],
  });
}
...
export function newDisplay(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.pub)],
  });
}
...
export function new__(txb: TransactionBlock, typeArg: string, args: New_Args) {
  return txb.moveCall({
...
export function merge(txb: TransactionBlock, typeArg: string, args: MergeArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::mint_pass::merge`,
    typeArguments: [typeArg],
    arguments: [obj(txb, args.mintPass), obj(txb, args.other)],
  });
}
...
export function incrementSupply(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.mintPass), pure(txb, args.quantity, `u64`)],
  });
}
...
export interface NewWithMetadataArgs {
  mintCap: ObjectArg;
  supply: bigint | TransactionArgument;
  metadata: Array<number | TransactionArgument> | TransactionArgument;
}
...
export function newWithMetadata(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [
      obj(txb, args.mintCap),
      pure(txb, args.supply, `u64`),
      pure(txb, args.metadata, `vector<u8>`),
    ],
  });
}
