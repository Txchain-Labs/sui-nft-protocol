...
export function isKey(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::Key<",
  );
}
...
export class Key<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => Key.fromBcs(T, data),
      bcs: Key.bcs,
...
export function isComposition(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::Composition<",
  );
}
  ...
  implements StructClass
{
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<Schema>],
    fields: CompositionFields<Schema>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      typeArgs: [extractType(Schema)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<Schema>>,
      ],
      reifiedTypeArgs: [Schema],
      fromFields: (fields: Record<string, any>) =>
        Composition.fromFields(Schema, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Composition.fromFieldsWithTypes(Schema, item),
      fromBcs: (data: Uint8Array) => Composition.fromBcs(Schema, data),
      bcs: Composition.bcs,
      fromJSONField: (field: any) => Composition.fromJSONField(Schema, field),
      fromJSON: (json: Record<string, any>) =>
        Composition.fromJSON(Schema, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Composition.fromSuiParsedData(Schema, content),
      fetch: async (client: SuiClient, id: string) =>
        Composition.fetch(client, Schema, id),
      new: (fields: CompositionFields<ToPhantomTypeArgument<Schema>>) => {
        return new Composition([extractType(Schema)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(Composition.reified(Schema));
  }
  ...
  static fromFields<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Composition.reified(typeArg).new({
      limits: decodeFromFields(
  ...
  static fromFieldsWithTypes<
    Schema extends PhantomReified<PhantomTypeArgument>,
  >(
    typeArg: Schema,
    item: FieldsWithTypes,
  ): Composition<ToPhantomTypeArgument<Schema>> {
    ...
    return Composition.reified(typeArg).new({
      limits: decodeFromFieldsWithTypes(
        VecMap.reified(TypeName.reified(), "u64"),
        item.fields.limits,
      ),
    });
  ...
  static fromBcs<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Composition.fromFields(typeArg, Composition.bcs.parse(data));
  }
  ...
  static fromJSON<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(Composition.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isComposition(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Composition object`,
      );
    }
    return Composition.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<Schema extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Composition object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isComposition(res.data.bcs.type)
    ) {
