...
export function addDomain(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.object), obj(txb, args.domain)],
  });
}
...
export function compose(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.composition),
      obj(txb, args.nfts),
      generic(txb, `${typeArgs[1]}`, args.childNft),
    ],
  });
}
...
export function addRelationship(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.composition), pure(txb, args.limit, `u64`)],
  });
}
...
export function assertComposable(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.composition), obj(txb, args.childType)],
  });
}
...
export interface AssertInsertableArgs {
  composition: ObjectArg;
  count: bigint | TransactionArgument;
}
...
export function assertInsertable(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.composition), pure(txb, args.count, `u64`)],
  });
}
...
export function compose_(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.nfts), generic(txb, `${typeArg}`, args.childNft)],
  });
}
...
export function composeWithCollectionSchema(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      obj(txb, args.parentNft),
      generic(txb, `${typeArgs[2]}`, args.childNft),
    ],
  });
}
...
export function newComposition(txb: TransactionBlock, typeArg: string) {
  return txb.moveCall({
