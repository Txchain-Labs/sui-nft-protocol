...
export function delegate(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.supply), pure(txb, args.quantity, `u64`)],
  });
}
...
export function addDomain(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.collection), obj(txb, args.domain)],
  });
}
...
export function mergeDelegated(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.supply), obj(txb, args.delegated)],
  });
}
