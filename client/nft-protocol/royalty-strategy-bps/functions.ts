...
export interface NewArgs {
  ...
  royaltyFeeBps: number | TransactionArgument;
}

export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.royaltyFeeBps, `u16`),
    ],
  });
}
...
export function drop(txb: TransactionBlock, typeArg: string, args: DropArgs) {
  return txb.moveCall({
...
export function disable(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.self)],
  });
}
...
export function share(txb: TransactionBlock, typeArg: string, self: ObjectArg) {
  return txb.moveCall({
...
export function calculate(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), pure(txb, args.amount, `u64`)],
  });
}
...
export function collectRoyalties(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.collection), obj(txb, args.strategy)],
  });
}

export interface Compute_Args {
  bps: number | TransactionArgument;
  amount: bigint | TransactionArgument;
}

export function compute_(txb: TransactionBlock, args: Compute_Args) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::royalty_strategy_bps::compute_`,
    arguments: [pure(txb, args.bps, `u16`), pure(txb, args.amount, `u64`)],
  });
}
...
export function confirmTransfer(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.self), obj(txb, args.req)],
  });
}
...
export function confirmTransferWithBalance(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.self), obj(txb, args.req), obj(txb, args.wallet)],
  });
}
...
export function createDomainAndAddStrategy(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.witness),
      obj(txb, args.collection),
      obj(txb, args.royaltyDomain),
      pure(txb, args.bps, `u16`),
    ],
  });
}
