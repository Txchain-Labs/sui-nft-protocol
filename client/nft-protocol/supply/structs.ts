...
export function isSupply(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::supply::Supply<",
  );
}

export interface SupplyFields<T extends PhantomTypeArgument> {
  frozen: ToField<"bool">;
  inner: ToField<Supply1>;
}
...
export class Supply<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly inner: ToField<Supply1>;
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Supply.reified(typeArg).new({
      ...
      inner: decodeFromFields(Supply1.reified(), fields.inner),
    });
  }
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Supply.reified(typeArg).new({
      ...
      inner: decodeFromFieldsWithTypes(Supply1.reified(), item.fields.inner),
    });
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Supply.reified(typeArg).new({
      ...
      inner: decodeFromJSONField(Supply1.reified(), field.inner),
    });
  }
