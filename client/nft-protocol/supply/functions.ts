...
export interface NewArgs {
  ...
  frozen: boolean | TransactionArgument;
}
...
export interface SplitArgs {
  supply: ObjectArg;
  splitMax: bigint | TransactionArgument;
}
...
export function split(txb: TransactionBlock, typeArg: string, args: SplitArgs) {
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.supply), pure(txb, args.splitMax, `u64`)],
  });
}
...
export function freezeSupply(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.supply)],
  });
}
...
export function freezeSupplyNft(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.object)],
  });
}
