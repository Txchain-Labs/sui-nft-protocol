...
export function newEmpty(txb: TransactionBlock) {
  return txb.moveCall({
...
export interface AddCollectionShareArgs {
  ...
  share: number | TransactionArgument;
}
...
export function addCollectionShare(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.to, `address`),
      pure(txb, args.share, `u16`),
    ],
  });
}
...
export function addShare(txb: TransactionBlock, args: AddShareArgs) {
  return txb.moveCall({
...
export function addShareToEmpty(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.domain), pure(txb, args.who, `address`)],
  });
}
...
export function addSharesToEmpty(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.domain), obj(txb, args.royaltySharesBps)],
  });
}

export interface AddStrategyArgs {
  domain: ObjectArg;
  strategy: string | TransactionArgument;
}

export function addStrategy(txb: TransactionBlock, args: AddStrategyArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::royalty::add_strategy`,
    arguments: [
      obj(txb, args.domain),
      pure(txb, args.strategy, `0x2::object::ID`),
    ],
  });
}

export function assertEmpty(txb: TransactionBlock, domain: ObjectArg) {
  return txb.moveCall({
...
export function assertNoRoyalty(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function assertRoyalty(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function assertTotalShares(txb: TransactionBlock, shares: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::royalty::assert_total_shares`,
    arguments: [obj(txb, shares)],
  });
}
...
export function borrowShare(txb: TransactionBlock, args: BorrowShareArgs) {
  return txb.moveCall({
...
export function borrowShares(txb: TransactionBlock, domain: ObjectArg) {
  return txb.moveCall({
...
export function containsShare(txb: TransactionBlock, args: ContainsShareArgs) {
  return txb.moveCall({
...
export function containsShares(txb: TransactionBlock, domain: ObjectArg) {
  return txb.moveCall({
...
export function distributeBalance(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.shares), obj(txb, args.aggregate)],
  });
}
...
export function fromAddress(
  ...
  return txb.moveCall({
    ...
    arguments: [pure(txb, who, `address`)],
  });
}

export function fromShares(txb: TransactionBlock, royaltySharesBps: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::royalty::from_shares`,
    arguments: [obj(txb, royaltySharesBps)],
  });
}
...
export function removeCollectionShare(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.collection), pure(txb, args.to, `address`)],
  });
}
...
export function removeCreatorByTransfer(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.domain), pure(txb, args.to, `address`)],
  });
}
...
export function strategies(txb: TransactionBlock, domain: ObjectArg) {
  return txb.moveCall({
