...
export interface NewArgs {
  witness: ObjectArg;
  futureRecipient: string | TransactionArgument;
}
...
export function new_(txb: TransactionBlock, typeArg: string, args: NewArgs) {
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.futureRecipient, `address`),
    ],
  });
}
...
export interface CreateAndTransferArgs {
  ...
  currentOwner: string | TransactionArgument;
}
...
export function createAndTransfer(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.currentOwner, `address`),
    ],
  });
}
