...
export function isTransferToken(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_token::TransferToken<",
  );
}
  ...
  implements StructClass
{
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        TransferToken.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TransferToken.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => TransferToken.fromBcs(T, data),
      bcs: TransferToken.bcs,
      fromJSONField: (field: any) => TransferToken.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => TransferToken.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TransferToken.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        TransferToken.fetch(client, T, id),
      new: (fields: TransferTokenFields<ToPhantomTypeArgument<T>>) => {
        return new TransferToken([extractType(T)], fields);
      },
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(TransferToken.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TransferToken.reified(typeArg).new({
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TransferToken.fromFields(typeArg, TransferToken.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(TransferToken.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isTransferToken(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TransferToken object`,
      );
    }
    return TransferToken.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching TransferToken object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTransferToken(res.data.bcs.type)
    ) {
...
export function isTransferTokenRule(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_token::TransferTokenRule"
  );
}
...
export class TransferTokenRule implements StructClass {
  ...
  static reified(): TransferTokenRuleReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        TransferTokenRule.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        TransferTokenRule.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => TransferTokenRule.fromBcs(data),
      bcs: TransferTokenRule.bcs,
      fromJSONField: (field: any) => TransferTokenRule.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => TransferTokenRule.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        TransferTokenRule.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        TransferTokenRule.fetch(client, id),
      new: (fields: TransferTokenRuleFields) => {
        return new TransferTokenRule([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): TransferTokenRule {
    return TransferTokenRule.reified().new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): TransferTokenRule {
  ...
  static fromBcs(data: Uint8Array): TransferTokenRule {
    return TransferTokenRule.fromFields(TransferTokenRule.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): TransferTokenRule {
    return TransferTokenRule.reified().new({
      dummyField: decodeFromJSONField("bool", field.dummyField),
    });
  }

  static fromJSON(json: Record<string, any>): TransferTokenRule {
  ...
  static fromSuiParsedData(content: SuiParsedData): TransferTokenRule {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isTransferTokenRule(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a TransferTokenRule object`,
      );
    }
    return TransferTokenRule.fromFieldsWithTypes(content);
  }
  ...
  static async fetch(
    ...
    if (res.error) {
      throw new Error(
        `error fetching TransferTokenRule object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isTransferTokenRule(res.data.bcs.type)
    ) {
