...
export function addNew(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.collection)],
  });
}
...
export function assertFieldAuth(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), obj(txb, args.field)],
  });
}
...
export function confirmFromCollection(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.collection), obj(txb, args.req)],
  });
}
...
export function emptyFieldAccess(txb: TransactionBlock) {
  return txb.moveCall({
...
export function emptyParentAccess(txb: TransactionBlock) {
  return txb.moveCall({
