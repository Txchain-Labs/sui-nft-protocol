...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::access_policy::Witness"
  );
}
...
export function isAccessPolicy(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::access_policy::AccessPolicy<",
  );
}
...
export interface AccessPolicyFields<T extends PhantomTypeArgument> {
  id: ToField<UID>;
  version: ToField<"u64">;
  parentAccess: ToField<VecSet<"address">>;
  fieldAccess: ToField<
    Table<ToPhantom<TypeName>, ToPhantom<VecSet<"address">>>
  >;
}
  ...
  implements StructClass
{
  ...
  readonly parentAccess: ToField<VecSet<"address">>;
  readonly fieldAccess: ToField<
    Table<ToPhantom<TypeName>, ToPhantom<VecSet<"address">>>
  >;

  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: AccessPolicyFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
    ...
    this.parentAccess = fields.parentAccess;
    this.fieldAccess = fields.fieldAccess;
  }
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        AccessPolicy.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AccessPolicy.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => AccessPolicy.fromBcs(T, data),
      bcs: AccessPolicy.bcs,
      fromJSONField: (field: any) => AccessPolicy.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => AccessPolicy.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AccessPolicy.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        AccessPolicy.fetch(client, T, id),
      new: (fields: AccessPolicyFields<ToPhantomTypeArgument<T>>) => {
        return new AccessPolicy([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(AccessPolicy.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AccessPolicy.reified(typeArg).new({
      id: decodeFromFields(UID.reified(), fields.id),
      version: decodeFromFields("u64", fields.version),
      parentAccess: decodeFromFields(
        VecSet.reified("address"),
        fields.parent_access,
      ),
      fieldAccess: decodeFromFields(
        Table.reified(
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AccessPolicy.reified(typeArg).new({
      ...
      parentAccess: decodeFromFieldsWithTypes(
        VecSet.reified("address"),
        item.fields.parent_access,
      ),
      fieldAccess: decodeFromFieldsWithTypes(
        Table.reified(
          reified.phantom(TypeName.reified()),
          reified.phantom(VecSet.reified("address")),
        ),
        item.fields.field_access,
      ),
    });
  }
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AccessPolicy.fromFields(typeArg, AccessPolicy.bcs.parse(data));
  }
  ...
  toJSONField() {
    return {
      ...
      parentAccess: this.parentAccess.toJSONField(),
      fieldAccess: this.fieldAccess.toJSONField(),
    };
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return AccessPolicy.reified(typeArg).new({
      ...
      parentAccess: decodeFromJSONField(
        VecSet.reified("address"),
        field.parentAccess,
      ),
      fieldAccess: decodeFromJSONField(
        Table.reified(
          reified.phantom(TypeName.reified()),
          reified.phantom(VecSet.reified("address")),
        ),
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(AccessPolicy.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isAccessPolicy(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AccessPolicy object`,
      );
    }
    return AccessPolicy.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching AccessPolicy object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAccessPolicy(res.data.bcs.type)
    ) {
...
export function isAccessPolicyRule(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::access_policy::AccessPolicyRule"
  );
}
...
export class AccessPolicyRule implements StructClass {
  ...
  static reified(): AccessPolicyRuleReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        AccessPolicyRule.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AccessPolicyRule.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => AccessPolicyRule.fromBcs(data),
      bcs: AccessPolicyRule.bcs,
      fromJSONField: (field: any) => AccessPolicyRule.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => AccessPolicyRule.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AccessPolicyRule.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        AccessPolicyRule.fetch(client, id),
      new: (fields: AccessPolicyRuleFields) => {
        return new AccessPolicyRule([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): AccessPolicyRule {
    return AccessPolicyRule.reified().new({
      dummyField: decodeFromFields("bool", fields.dummy_field),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): AccessPolicyRule {
  ...
  static fromBcs(data: Uint8Array): AccessPolicyRule {
    return AccessPolicyRule.fromFields(AccessPolicyRule.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): AccessPolicyRule {
    return AccessPolicyRule.reified().new({
      dummyField: decodeFromJSONField("bool", field.dummyField),
    });
  }

  static fromJSON(json: Record<string, any>): AccessPolicyRule {
  ...
  static fromSuiParsedData(content: SuiParsedData): AccessPolicyRule {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isAccessPolicyRule(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AccessPolicyRule object`,
      );
    }
    return AccessPolicyRule.fromFieldsWithTypes(content);
  }

  static async fetch(client: SuiClient, id: string): Promise<AccessPolicyRule> {
    const res = await client.getObject({
      id,
      options: {
        showBcs: true,
    ...
    if (res.error) {
      throw new Error(
        `error fetching AccessPolicyRule object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAccessPolicyRule(res.data.bcs.type)
    ) {
...
export function isNewPolicyEvent(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::access_policy::NewPolicyEvent"
  );
}
...
export class NewPolicyEvent implements StructClass {
  ...
  static reified(): NewPolicyEventReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        NewPolicyEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        NewPolicyEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => NewPolicyEvent.fromBcs(data),
      bcs: NewPolicyEvent.bcs,
      fromJSONField: (field: any) => NewPolicyEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) => NewPolicyEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        NewPolicyEvent.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        NewPolicyEvent.fetch(client, id),
      new: (fields: NewPolicyEventFields) => {
        return new NewPolicyEvent([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields(fields: Record<string, any>): NewPolicyEvent {
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): NewPolicyEvent {
  ...
  static fromBcs(data: Uint8Array): NewPolicyEvent {
    return NewPolicyEvent.fromFields(NewPolicyEvent.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): NewPolicyEvent {
    return NewPolicyEvent.reified().new({
  ...
  static fromJSON(json: Record<string, any>): NewPolicyEvent {
  ...
  static fromSuiParsedData(content: SuiParsedData): NewPolicyEvent {
    if (content.dataType !== "moveObject") {
      throw new Error("not an object");
    }
    if (!isNewPolicyEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a NewPolicyEvent object`,
      );
    }
    return NewPolicyEvent.fromFieldsWithTypes(content);
  }

  static async fetch(client: SuiClient, id: string): Promise<NewPolicyEvent> {
    const res = await client.getObject({
      id,
      options: {
        showBcs: true,
    ...
    if (res.error) {
      throw new Error(
        `error fetching NewPolicyEvent object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isNewPolicyEvent(res.data.bcs.type)
    ) {
