...
export interface NewArgs {
  witness: GenericArg;
  collectionId: string | TransactionArgument;
  supply: bigint | TransactionArgument | TransactionArgument | null;
}
...
export function new_(
  ...
  return txb.moveCall({
    ...
    arguments: [
      ...
      pure(txb, args.collectionId, `0x2::object::ID`),
      pure(txb, args.supply, `0x1::option::Option<u64>`),
    ],
  });
}
...
export function split(txb: TransactionBlock, typeArg: string, args: SplitArgs) {
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.mintCap), pure(txb, args.quantity, `u64`)],
  });
}
...
export function merge(txb: TransactionBlock, typeArg: string, args: MergeArgs) {
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.mintCap), obj(txb, args.other)],
  });
}
