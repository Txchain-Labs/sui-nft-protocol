...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::Witness"
  );
}
...
export function isMintCap(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<",
  );
}
...
export class MintCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly supply: ToField<Option<Supply>>;

  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: MintCapFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      MintCap.$typeName,
      ...typeArgs,
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        MintCap.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintCap.fromFieldsWithTypes(T, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        MintCap.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        MintCap.fetch(client, T, id),
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MintCap.reified(typeArg).new({
      ...
      supply: decodeFromFields(Option.reified(Supply.reified()), fields.supply),
    });
  }
  ...
  toJSONField() {
    return {
      ...
      supply: fieldToJSON<Option<Supply>>(
        `0x1::option::Option<0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils_supply::Supply>`,
        this.supply,
      ),
    };
  }
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isMintCap(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MintCap object`,
      );
    }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching MintCap object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMintCap(res.data.bcs.type)
    ) {
