...
export function getDescription(txb: TransactionBlock, displayInfo: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::display_info::get_description`,
    arguments: [obj(txb, displayInfo)],
  });
}

export function getName(txb: TransactionBlock, displayInfo: ObjectArg) {
  return txb.moveCall({
...
export function assertDisplay(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function assertNoDisplay(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export interface ChangeDescriptionArgs {
  objectUid: ObjectArg;
  newDescription: string | TransactionArgument;
}
...
export function changeDescription(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.objectUid),
      pure(txb, args.newDescription, `0x1::string::String`),
    ],
  });
}
...
export function getNameMut(txb: TransactionBlock, displayInfo: ObjectArg) {
  return txb.moveCall({
