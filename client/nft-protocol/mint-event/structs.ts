...
export function isBurnEvent(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::BurnEvent<",
  );
}
...
export class BurnEvent<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly object: ToField<ID>;

  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: BurnEventFields<T>,
  ) {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        BurnEvent.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BurnEvent.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => BurnEvent.fromBcs(T, data),
      bcs: BurnEvent.bcs,
      fromJSONField: (field: any) => BurnEvent.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => BurnEvent.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BurnEvent.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        BurnEvent.fetch(client, T, id),
      new: (fields: BurnEventFields<ToPhantomTypeArgument<T>>) => {
        return new BurnEvent([extractType(T)], fields);
      },
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(BurnEvent.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BurnEvent.reified(typeArg).new({
      ...
      object: decodeFromFields(ID.reified(), fields.object),
    });
  }
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BurnEvent.reified(typeArg).new({
      ...
      object: decodeFromFieldsWithTypes(ID.reified(), item.fields.object),
    });
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BurnEvent.reified(typeArg).new({
      ...
      object: decodeFromJSONField(ID.reified(), field.object),
    });
  }
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isBurnEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a BurnEvent object`,
      );
    }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching BurnEvent object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBurnEvent(res.data.bcs.type)
    ) {
...
export function isBurnGuard(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::BurnGuard<",
  );
}
...
export class BurnGuard<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        BurnGuard.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BurnGuard.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => BurnGuard.fromBcs(T, data),
      bcs: BurnGuard.bcs,
      fromJSONField: (field: any) => BurnGuard.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => BurnGuard.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BurnGuard.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        BurnGuard.fetch(client, T, id),
      new: (fields: BurnGuardFields<ToPhantomTypeArgument<T>>) => {
        return new BurnGuard([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(BurnGuard.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BurnGuard.reified(typeArg).new({
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BurnGuard.fromFields(typeArg, BurnGuard.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(BurnGuard.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isBurnGuard(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a BurnGuard object`,
      );
    }
    return BurnGuard.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching BurnGuard object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isBurnGuard(res.data.bcs.type)
    ) {
...
export function isMintEvent(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::MintEvent<",
  );
}
...
export class MintEvent<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        MintEvent.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintEvent.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => MintEvent.fromBcs(T, data),
      bcs: MintEvent.bcs,
      fromJSONField: (field: any) => MintEvent.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => MintEvent.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MintEvent.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        MintEvent.fetch(client, T, id),
      new: (fields: MintEventFields<ToPhantomTypeArgument<T>>) => {
        return new MintEvent([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(MintEvent.reified(T));
  }
