...
export function delete_(txb: TransactionBlock, nftBag: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::nft_bag::delete`,
    arguments: [obj(txb, nftBag)],
  });
}

export interface BorrowNftArgs {
  nft: ObjectArg;
  childNftId: string | TransactionArgument;
}
...
export function borrowNft(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.nft),
      pure(txb, args.childNftId, `0x2::object::ID`),
    ],
  });
}
...
export function assertNftBag(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function assertNoNftBag(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function compose(
  ...
  return txb.moveCall({
    ...
    arguments: [
      generic(txb, `${typeArgs[1]}`, args.authority),
      obj(txb, args.domain),
      generic(txb, `${typeArgs[0]}`, args.childNft),
    ],
  });
}
...
export function getAuthorities(txb: TransactionBlock, nftBag: ObjectArg) {
  return txb.moveCall({
...
export function getAuthorityIdx(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.authorityType), obj(txb, args.domain)],
  });
}

export function getNfts(txb: TransactionBlock, nftBag: ObjectArg) {
  return txb.moveCall({
...
export function has(txb: TransactionBlock, args: HasArgs) {
  return txb.moveCall({
