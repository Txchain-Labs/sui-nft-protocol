...
export function delete_(txb: TransactionBlock, allowlists: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::p2p_list_domain::delete`,
    arguments: [obj(txb, allowlists)],
  });
}
...
export function addId(txb: TransactionBlock, typeArg: string, args: AddIdArgs) {
  return txb.moveCall({
...
export function assertTransferAllowlist(txb: TransactionBlock, nft: ObjectArg) {
  return txb.moveCall({
...
export function borrowAllowlists(txb: TransactionBlock, domain: ObjectArg) {
  return txb.moveCall({
