...
export function name(txb: TransactionBlock, typeArg: string, nft: ObjectArg) {
  return txb.moveCall({
...
export function url(txb: TransactionBlock, typeArg: string, nft: ObjectArg) {
  return txb.moveCall({
...
export function addDomain(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.witness),
      obj(txb, args.nft),
      generic(txb, `${typeArgs[1]}`, args.domain),
    ],
  });
}
...
export function borrowDomainMut(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.witness), obj(txb, args.nft)],
  });
}
...
export function setUrl(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.witness), obj(txb, args.nft), obj(txb, args.url)],
  });
}
