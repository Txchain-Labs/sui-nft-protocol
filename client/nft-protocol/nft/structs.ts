...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft::Witness"
  );
}
...
export function isMintNftEvent(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft::MintNftEvent"
  );
}
...
export class MintNftEvent implements StructClass {
  ...
  static reified(): MintNftEventReified {
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        MintNftEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintNftEvent.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        MintNftEvent.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        MintNftEvent.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): MintNftEvent {
    ...
    if (!isMintNftEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MintNftEvent object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<MintNftEvent> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching MintNftEvent object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMintNftEvent(res.data.bcs.type)
    ) {
...
export function isNft(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft::Nft<",
  );
}

export interface NftFields<C extends PhantomTypeArgument> {
  id: ToField<UID>;
  name: ToField<String1>;
  url: ToField<Url>;
}
...
export class Nft<C extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      typeArgs: [extractType(C)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<C>>,
      ],
      reifiedTypeArgs: [C],
      fromFields: (fields: Record<string, any>) => Nft.fromFields(C, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Nft.fromFieldsWithTypes(C, item),
      fromBcs: (data: Uint8Array) => Nft.fromBcs(C, data),
      bcs: Nft.bcs,
      fromJSONField: (field: any) => Nft.fromJSONField(C, field),
      fromJSON: (json: Record<string, any>) => Nft.fromJSON(C, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Nft.fromSuiParsedData(C, content),
      fetch: async (client: SuiClient, id: string) => Nft.fetch(client, C, id),
      new: (fields: NftFields<ToPhantomTypeArgument<C>>) => {
        return new Nft([extractType(C)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static fromFields<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Nft.reified(typeArg).new({
      id: decodeFromFields(UID.reified(), fields.id),
      name: decodeFromFields(String1.reified(), fields.name),
  ...
  static fromFieldsWithTypes<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Nft.reified(typeArg).new({
      ...
      name: decodeFromFieldsWithTypes(String1.reified(), item.fields.name),
  ...
  static fromBcs<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Nft.fromFields(typeArg, Nft.bcs.parse(data));
  }
  ...
  static fromJSONField<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Nft.reified(typeArg).new({
      ...
      name: decodeFromJSONField(String1.reified(), field.name),
  ...
  static fromJSON<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(Nft.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isNft(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Nft object`,
      );
    }
    return Nft.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static async fetch<C extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Nft object at id ${id}: ${res.error.code}`,
      );
    }
