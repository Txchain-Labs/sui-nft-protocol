...
export function isWitness(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Witness"
  );
}
...
export function isCollection(type: string): boolean {
  ...
  return type.startsWith(
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<",
  );
}
...
export class Collection<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        Collection.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Collection.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => Collection.fromBcs(T, data),
      bcs: Collection.bcs,
      fromJSONField: (field: any) => Collection.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => Collection.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Collection.fromSuiParsedData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        Collection.fetch(client, T, id),
      new: (fields: CollectionFields<ToPhantomTypeArgument<T>>) => {
        return new Collection([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(Collection.reified(T));
  }
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Collection.reified(typeArg).new({
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Collection.fromFields(typeArg, Collection.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(Collection.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Collection.fromFieldsWithTypes(typeArg, content);
  }
...
export function isMintCollectionEvent(type: string): boolean {
  ...
  return (
    type ===
    "0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::MintCollectionEvent"
  );
}

export interface MintCollectionEventFields {
  collectionId: ToField<ID>;
...
export class MintCollectionEvent implements StructClass {
  ...
  readonly collectionId: ToField<ID>;
  ...
  static reified(): MintCollectionEventReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        MintCollectionEvent.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        MintCollectionEvent.fromFieldsWithTypes(item),
      fromBcs: (data: Uint8Array) => MintCollectionEvent.fromBcs(data),
      bcs: MintCollectionEvent.bcs,
      fromJSONField: (field: any) => MintCollectionEvent.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        MintCollectionEvent.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        MintCollectionEvent.fromSuiParsedData(content),
      fetch: async (client: SuiClient, id: string) =>
        MintCollectionEvent.fetch(client, id),
      new: (fields: MintCollectionEventFields) => {
        return new MintCollectionEvent([], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static get bcs() {
    return bcs.struct("MintCollectionEvent", {
      collection_id: ID.bcs,
      type_name: TypeName.bcs,
    });
  }

  static fromFields(fields: Record<string, any>): MintCollectionEvent {
    return MintCollectionEvent.reified().new({
      collectionId: decodeFromFields(ID.reified(), fields.collection_id),
      typeName: decodeFromFields(TypeName.reified(), fields.type_name),
    });
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): MintCollectionEvent {
    if (!isMintCollectionEvent(item.type)) {
      throw new Error("not a MintCollectionEvent type");
    }

    return MintCollectionEvent.reified().new({
      collectionId: decodeFromFieldsWithTypes(
        ID.reified(),
        item.fields.collection_id,
      ),
  ...
  static fromBcs(data: Uint8Array): MintCollectionEvent {
    return MintCollectionEvent.fromFields(MintCollectionEvent.bcs.parse(data));
  }
  ...
  static fromJSONField(field: any): MintCollectionEvent {
    return MintCollectionEvent.reified().new({
      collectionId: decodeFromJSONField(ID.reified(), field.collectionId),
      typeName: decodeFromJSONField(TypeName.reified(), field.typeName),
    });
  }

  static fromJSON(json: Record<string, any>): MintCollectionEvent {
  ...
  static fromSuiParsedData(content: SuiParsedData): MintCollectionEvent {
    ...
    if (!isMintCollectionEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a MintCollectionEvent object`,
      );
    }
    return MintCollectionEvent.fromFieldsWithTypes(content);
  }
  ...
  static async fetch(
    ...
    if (res.error) {
      throw new Error(
        `error fetching MintCollectionEvent object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isMintCollectionEvent(res.data.bcs.type)
    ) {
