...
export function assertVersion(txb: TransactionBlock, kioskUid: ObjectArg) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::ob_kiosk::assert_version`,
    arguments: [obj(txb, kioskUid)],
  });
}
...
export function borrowCap(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function migrateAsPub(txb: TransactionBlock, args: MigrateAsPubArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::ob_kiosk::migrate_as_pub`,
    arguments: [obj(txb, args.self), obj(txb, args.pub)],
  });
}

export function migrate(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export interface BorrowNftArgs {
  self: ObjectArg;
  nftId: string | TransactionArgument;
}
...
export function borrowNft(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), pure(txb, args.nftId, `0x2::object::ID`)],
  });
}

export interface ReturnNftArgs {
  self: ObjectArg;
  borrowedNft: ObjectArg;
  policy: ObjectArg;
}
...
export function assertHasNft(txb: TransactionBlock, args: AssertHasNftArgs) {
  return txb.moveCall({
...
export function assertIsObKiosk(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function assertIsPermissionless(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function assertKioskId(txb: TransactionBlock, args: AssertKioskIdArgs) {
  return txb.moveCall({
...
export function assertMissingRef(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.refs), pure(txb, args.nftId, `0x2::object::ID`)],
  });
}
...
export function assertOwnerAddress(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), pure(txb, args.owner, `address`)],
  });
}

export function assertPermission(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function assertRefNotExclusivelyListed(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, ref)],
  });
}

export function assertRefNotListed(txb: TransactionBlock, ref: ObjectArg) {
  return txb.moveCall({
...
export function authExclusiveTransfer(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.self),
      pure(txb, args.nftId, `0x2::object::ID`),
      obj(txb, args.entityId),
    ],
  });
}
...
export interface AuthTransferArgs {
  self: ObjectArg;
  nftId: string | TransactionArgument;
  entity: string | TransactionArgument;
}

export function authTransfer(txb: TransactionBlock, args: AuthTransferArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::ob_kiosk::auth_transfer`,
    arguments: [
      obj(txb, args.self),
      pure(txb, args.nftId, `0x2::object::ID`),
      pure(txb, args.entity, `address`),
    ],
  });
}
...
export interface BorrowNftMutArgs {
  self: ObjectArg;
  nftId: string | TransactionArgument;
  field: ObjectArg | TransactionArgument | null;
}
...
export function borrowNftMut(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.self),
      pure(txb, args.nftId, `0x2::object::ID`),
      option(txb, `0x1::type_name::TypeName`, args.field),
    ],
  });
}
...
export function createForSender(txb: TransactionBlock) {
  return txb.moveCall({
...
export function createPermissionless(txb: TransactionBlock) {
  return txb.moveCall({
...
export interface DelegateAuthArgs {
  ...
  nftId: string | TransactionArgument;
  oldEntity: ObjectArg;
  newEntity: string | TransactionArgument;
}

export function delegateAuth(txb: TransactionBlock, args: DelegateAuthArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::ob_kiosk::delegate_auth`,
    arguments: [
      obj(txb, args.self),
      pure(txb, args.nftId, `0x2::object::ID`),
      obj(txb, args.oldEntity),
      pure(txb, args.newEntity, `address`),
    ],
  });
}
...
export function deposit(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), generic(txb, `${typeArg}`, args.nft)],
  });
}
...
export interface DepositBatchArgs {
  self: ObjectArg;
  nfts: Array<GenericArg> | TransactionArgument;
}
...
export function depositBatch(
  ...
  return txb.moveCall({
    ...
    typeArguments: [typeArg],
    arguments: [obj(txb, args.self), vector(txb, `${typeArg}`, args.nfts)],
  });
}

export function depositSettingMut(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function enableAnyDeposit(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function initForSender(txb: TransactionBlock) {
  return txb.moveCall({
...
export function initPermissionless(txb: TransactionBlock) {
  return txb.moveCall({
...
export function installExtension(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), obj(txb, args.kioskCap)],
  });
}
...
export function isObKiosk(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function isObKioskImut(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function isOwner(txb: TransactionBlock, args: IsOwnerArgs) {
  return txb.moveCall({
    target: `${PUBLISHED_AT}::ob_kiosk::is_owner`,
    arguments: [obj(txb, args.self), pure(txb, args.address, `address`)],
  });
}

export function isPermissionless(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function newPermissionless(txb: TransactionBlock) {
  return txb.moveCall({
...
export function nftRef(txb: TransactionBlock, args: NftRefArgs) {
  return txb.moveCall({
...
export function nftRefMut(txb: TransactionBlock, args: NftRefMutArgs) {
  return txb.moveCall({
...
export function nftRefs(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function nftRefsMut(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function p2pTransferAndCreateTargetKiosk(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.source),
      pure(txb, args.target, `address`),
      pure(txb, args.nftId, `0x2::object::ID`),
    ],
  });
}

export function popCap(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export interface RemoveNftArgs {
  self: ObjectArg;
  nftId: string | TransactionArgument;
  originator: string | TransactionArgument;
}
...
export function removeNft(
  ...
  return txb.moveCall({
    ...
    arguments: [
      obj(txb, args.self),
      pure(txb, args.nftId, `0x2::object::ID`),
      pure(txb, args.originator, `address`),
    ],
  });
}

export function restrictDeposits(txb: TransactionBlock, self: ObjectArg) {
  return txb.moveCall({
...
export function setCap(txb: TransactionBlock, args: SetCapArgs) {
  return txb.moveCall({
...
export function setPermissionlessToPermissioned(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), pure(txb, args.user, `address`)],
  });
}
...
export function setTransferRequestAuth(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.req), generic(txb, `${typeArgs[1]}`, args.auth)],
  });
}
...
export function setTransferRequestAuth_(
  ...
  return txb.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(txb, args.req), generic(txb, `${typeArgs[2]}`, args.auth)],
  });
}
...
export function uninstallExtension(
  ...
  return txb.moveCall({
    ...
    arguments: [obj(txb, args.self), obj(txb, args.ownerToken)],
  });
}
